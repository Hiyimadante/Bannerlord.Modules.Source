...
{
	private struct CameraParameters(float azimuth, float inclination, float distance, float deviation)
	{
	...
	private struct StaticCameraParameters(float horizontalRotationSensitivity, float verticalRotationSensitivity, float zoomSensitivity, float sensitivityMappingMultiplier, float deviationSensitivityAtMinDistance, float deviationSensitivityAtMaxDistance, float minCameraInclination, float maxCameraInclinationAtMinDistance, float maxCameraInclinationAtMaxDistance, float minCameraDistance, float maxCameraDistance, float minCameraDistanceWhileInspectingPiece, float cameraDeviationLimit, float focusDistanceAtMinDistance, float focusDistanceAtMaxDistance, float extraHeightAtMinDistance, float extraHeightAtMaxDistance)
	{
		public float HorizontalRotationSensitivity = horizontalRotationSensitivity;

		public float VerticalRotationSensitivity = verticalRotationSensitivity;

		public float ZoomSensitivity = zoomSensitivity;

		public float SensitivityMappingMultiplier = sensitivityMappingMultiplier;

		public float DeviationSensitivityAtMinDistance = deviationSensitivityAtMinDistance;

		public float DeviationSensitivityAtMaxDistance = deviationSensitivityAtMaxDistance;

		public float MinCameraInclination = minCameraInclination;

		public float MaxCameraInclinationAtMinDistance = maxCameraInclinationAtMinDistance;

		public float MaxCameraInclinationAtMaxDistance = maxCameraInclinationAtMaxDistance;

		public float MinCameraDistance = minCameraDistance;

		public float MaxCameraDistance = maxCameraDistance;

		public float MinCameraDistanceWhileInspectingPiece = minCameraDistanceWhileInspectingPiece;

		public float CameraDeviationLimit = cameraDeviationLimit;

		public float FocusDistanceAtMinDistance = focusDistanceAtMinDistance;

		public float FocusDistanceAtMaxDistance = focusDistanceAtMaxDistance;

		public float ExtraHeightAtMinDistance = extraHeightAtMinDistance;

		public float ExtraHeightAtMaxDistance = extraHeightAtMaxDistance;
	}
	...
	public GauntletPortScreen(PortState portState)
	{
		...
		_shipForwardDirection = Vec3.Forward;
		_shipSideDirection = Vec3.Side;
		((ScreenBase)this)._002Ector();
		_portState = portState;
		_initialCameraValues = new CameraParameters(2.2f, 1.45f, 40f, 0f);
		_staticCameraValues = new StaticCameraParameters(0.2f, 0.1f, 0.015f, 1920f, 15f, 25f, MathF.PI / 4f, MathF.PI * 2f / 3f, MathF.PI * 19f / 36f, 15f, 50f, 5f, 15f, 50f, 3000f, 0f, 6f);
	...
	void IGameStateListener.OnFinalize()
	{
		...
		if (_sceneLayer != null && (NativeObject)(object)_scene != (NativeObject)null)
		{
			DestroyScene();
		}
	}
	...
	private void CreateScene()
	{
		...
		_scene.SetUseAdvancedWaterRendering(true);
	...
	private void UpdateCamera(float dt)
	{
		...
		float num3 = AnimationInterpolation.Ease((Type)2, (Function)0, num2);
		currentCameraTargetPosition.z += MathF.Lerp(_staticCameraValues.ExtraHeightAtMinDistance, _staticCameraValues.ExtraHeightAtMaxDistance, num3, 1E-05f);
		...
		float num4 = AnimationInterpolation.Ease((Type)1, (Function)2, num2);
		float num5 = MathF.Lerp(_staticCameraValues.FocusDistanceAtMinDistance, _staticCameraValues.FocusDistanceAtMaxDistance, num4, 1E-05f);
		_scene.SetDepthOfFieldParameters(num5, num5, true);
		_sceneLayer.SetCamera(_sceneCamera);

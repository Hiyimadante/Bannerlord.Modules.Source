...
public struct NavalCustomBattleData
{
	...
	public static IEnumerable<Tuple<string, string>> GameTypes
	{
		get
		{
			yield return new Tuple<string, string>(((object)new TextObject("{=lr2UaD9m}Naval Battle", (Dictionary<string, object>)null)).ToString(), "NavalBattle");
			yield return new Tuple<string, string>(((object)new TextObject("{=3oDQHZrf}Naval Raid", (Dictionary<string, object>)null)).ToString(), "NavalRaid");
		}
	}

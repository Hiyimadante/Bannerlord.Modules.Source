...
public class NavalCustomBattleShipSelectionPopUpVM : ViewModel
{
	...
	public NavalCustomBattleShipSelectionPopUpVM()
	{
		...
		((Collection<NavalCustomBattleShipHullItemVM>)(object)obj).Add(new NavalCustomBattleShipHullItemVM(new TextObject("{=koX9okuG}None", (Dictionary<string, object>)null), new TextObject("{=fNyb979i}Must have at least one ship", (Dictionary<string, object>)null), (Action<NavalCustomBattleShipHullItemVM>)OnShipHullSelected));
		Items = obj;
		foreach (ShipHull shipHull in NavalCustomBattleData.ShipHulls)
		{
			((Collection<NavalCustomBattleShipHullItemVM>)(object)Items).Add(new NavalCustomBattleShipHullItemVM(shipHull, new TextObject("{=d3WMrFKo}Not usable in selected game mode", (Dictionary<string, object>)null), OnShipHullSelected));
		}
	}

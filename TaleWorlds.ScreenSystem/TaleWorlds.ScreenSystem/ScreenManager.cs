...
public static class ScreenManager
{
	...
	private static void DeactivateAndFinalizeAllScreens()
	{
		...
		for (int num = _screenList.Count - 1; num >= 0; num--)
		{
			...
			OnPopScreen?.Invoke(_screenList[num]);
	...
	{
		return PlatformTextRequested?.Invoke(initialText, descriptionText, maxLength, keyboardTypeEnum) ?? false;
	}

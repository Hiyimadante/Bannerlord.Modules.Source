...
public class KingdomDiplomacyVM : KingdomCategoryVM
{
	...
	private void OnSetWarItem(KingdomWarItemVM item)
	{
		...
		int dailyPeaceTributeToPay = Campaign.Current.Models.DiplomacyModel.GetDailyTributeToPay(Clan.PlayerClan, item.Faction2.Leader.Clan, out var durationInDays);

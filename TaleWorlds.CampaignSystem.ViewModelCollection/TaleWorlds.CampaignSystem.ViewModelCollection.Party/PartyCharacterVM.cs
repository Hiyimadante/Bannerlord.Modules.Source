...
public class PartyCharacterVM : ViewModel
{
	...
	{
		string recruitableReasonString = _partyScreenLogic.GetRecruitableReasonString(Troop.Character, IsTroopRecruitable, Troop.Number, out var showStackModifierText);
	...
	public void InitializeUpgrades()
	{
		if (IsUpgradableTroop)
		{
			for (int i = 0; i < Character.UpgradeTargets.Length; i++)
			{
				...
				bool flag3 = Campaign.Current.Models.PartyTroopUpgradeModel.DoesPartyHaveRequiredPerksForUpgrade(PartyBase.MainParty, Character, characterObject, out var requiredPerk);

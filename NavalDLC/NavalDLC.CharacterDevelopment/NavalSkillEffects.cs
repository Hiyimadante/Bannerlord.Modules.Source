...
public class NavalSkillEffects
{
	...
	private void InitializeAll()
	{
		...
		_effectNavalBattleUnderwaterBreathingDurationBonus.Initialize(new TextObject("{=95kCGbUp}Naval battle underwater breathing duration: +{a0} Seconds", (Dictionary<string, object>)null), NavalSkills.Mariner, (PartyRole)12, 0.005f, (EffectIncrementType)1, 0f, 0f, 20f);

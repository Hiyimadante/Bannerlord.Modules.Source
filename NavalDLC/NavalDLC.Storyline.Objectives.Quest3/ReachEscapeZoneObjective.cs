...
internal class ReachEscapeZoneObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=nGpnbplB}Escape Zone", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=4YtHaWFC}Reach the open seas by avoiding enemy ships.", (Dictionary<string, object>)null);
		}
	}

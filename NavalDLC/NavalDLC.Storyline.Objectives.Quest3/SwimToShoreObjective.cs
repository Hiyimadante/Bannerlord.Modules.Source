...
internal class SwimToShoreObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=h8HcPYjn}Swim to shore", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=dBQj9VSX}Swim to shore and reach your horses.", (Dictionary<string, object>)null);
		}
	}

...
internal class ReachShipObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=4mQj5K5L}Reach the ship", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=fE1Atxa5}Get to the Sturgian ship. There may be enemies nearby.", (Dictionary<string, object>)null);
		}
	}
	...
	internal ReachShipObjective(Mission mission, Agent gunnarAgent, MissionShip ship)
	{
		...
		_targets = new List<CheckpointObjectiveTarget>();
		...
		{
			((MissionObjective)this).AddTarget((MissionObjectiveTarget)(object)new AgentObjectiveTarget(gunnarAgent));
		}

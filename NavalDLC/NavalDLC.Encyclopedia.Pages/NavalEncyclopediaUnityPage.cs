...
public class NavalEncyclopediaUnityPage : DefaultEncyclopediaUnitPage
{
	protected override List<EncyclopediaFilterItem> GetTypeFilterItems()
	{
		...
		typeFilterItems.Add(new EncyclopediaFilterItem(new TextObject("{=bOhiqquf}Mariner", (Dictionary<string, object>)null), (Predicate<object>)delegate(object s)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return ((CharacterObject)s).IsMariner;
		}));

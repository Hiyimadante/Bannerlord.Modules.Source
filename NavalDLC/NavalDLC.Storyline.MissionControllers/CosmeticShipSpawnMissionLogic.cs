...
public class CosmeticShipSpawnMissionLogic : MissionLogic
{
	...
	private void SpawnShip(ShipHull shipHull)
	{
		...
		GameEntity val = VisualShipFactory.CreateVisualShip(obj.Prefab, ((MissionBehavior)this).Mission.Scene, new List<ShipVisualSlotInfo>(), MBRandom.RandomInt(), 1f, num, num2, true, true);

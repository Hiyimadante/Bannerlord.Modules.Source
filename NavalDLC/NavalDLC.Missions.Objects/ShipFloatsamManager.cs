...
public class ShipFloatsamManager : ScriptComponentBehavior
{
	...
	internal ShipFloatsamManager()
	{
		...
		_scrapeRecords = new Dictionary<WeakGameEntity, ScrapeRecord>();
		_scrapeParticleIndex = -1;
		_collisionHitParticleIndex = -1;
		_midCollisionHitParticleIndex = -1;
		_bigCollisionHitParticleIndex = -1;
		_randomGenerator = new MBFastRandom();
		_impulseRecordsToProcess = new ImpulseRecord[10];
		_shieldBreakRecords = new ShieldBreakRecord[10];

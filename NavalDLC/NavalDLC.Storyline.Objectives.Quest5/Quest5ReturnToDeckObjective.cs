...
public class Quest5ReturnToDeckObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=Cvwf3F6h}Return to Gunnar", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=ZRLg1dYM}Leave the hold to talk to Gunnar.", (Dictionary<string, object>)null);
		}
	}

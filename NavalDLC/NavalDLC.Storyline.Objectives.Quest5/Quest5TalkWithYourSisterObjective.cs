...
public class Quest5TalkWithYourSisterObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=btfAQ47G}Find your sister", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=VTjKuGYw}Find your sister in the hold of the prisoner ship.", (Dictionary<string, object>)null);
		}
	}

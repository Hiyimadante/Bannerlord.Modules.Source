...
public class Quest5ApproachObjective : MissionObjective
{
	private class ApproachObjectiveTarget : MissionObjectiveTarget
	{
		...
		public ApproachObjectiveTarget(MatrixFrame approachTargetFrame)
		{
			...
			((MissionObjectiveTarget)this)._002Ector();
	...
	public override TextObject Name
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=s8t5kclT}Approach the meeting zone", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=EmIS3tfC}Sail to within hailing distance of the Sea Hound ship.", (Dictionary<string, object>)null);
		}
	}

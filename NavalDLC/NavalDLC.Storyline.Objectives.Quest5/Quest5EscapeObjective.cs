...
public class Quest5EscapeObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=BkIpqqTD}Hold Off Sea Hounds", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=ZTiHqbi9}Fight off any Sea Hound pursuers until Gunnar can steer the ship to safety.", (Dictionary<string, object>)null);
		}
	}

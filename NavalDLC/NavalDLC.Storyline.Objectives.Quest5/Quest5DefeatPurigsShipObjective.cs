...
public class Quest5DefeatPurigsShipObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=CedcuMUS}Defeat Purig's crew", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=YDPv1Nsm}Board Purig's ship and defeat his crew.", (Dictionary<string, object>)null);
		}
	}

...
public class Quest5SwimObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=zcQhNQ7i}Reach the prisoner ship", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=lXv922C6}Swim with Gunnar to the ship where the captives are held.", (Dictionary<string, object>)null);
		}
	}

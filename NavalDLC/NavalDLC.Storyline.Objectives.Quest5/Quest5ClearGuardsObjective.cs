...
public class Quest5ClearGuardsObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=qc5Ymr0P}Take out the guards", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=12lWaxfF}Take out the guards as stealthily as possible.", (Dictionary<string, object>)null);
		}
	}

...
public class Quest5JumpObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=tbHD7j4G}Follow Gunnar into the water", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=bNX3b3Ry}Jump off the ship, following Gunnar into the water.", (Dictionary<string, object>)null);
		}
	}

...
internal class SinkShipObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=VMVbnNau}Sink Fahda's Flagship", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=rlEJ3pC8}Fahda's flagship was crippled by the storm. Ram it until it sinks!", (Dictionary<string, object>)null);
		}
	}

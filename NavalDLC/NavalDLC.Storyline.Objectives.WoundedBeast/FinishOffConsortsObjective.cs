...
internal class FinishOffConsortsObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=seOnzgCs}Defeat Fahda's consorts", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=3lZywscl}Fahda's flagship is going down. Defeat the rest of her fleet.", (Dictionary<string, object>)null);
		}
	}

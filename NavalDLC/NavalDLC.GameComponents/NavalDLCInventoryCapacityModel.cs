...
public class NavalDLCInventoryCapacityModel : InventoryCapacityModel
{
	...
	static NavalDLCInventoryCapacityModel()
	{
		...
		_textTroopMounts = new TextObject("{=GIlU4NXm}Troops' Mounts", (Dictionary<string, object>)null);
		_textMountsAndPackAnimals = new TextObject("{=Sb1MKbvP}Mounts and Pack Animals", (Dictionary<string, object>)null);
		_textLiveStocksAnimals = new TextObject("{=KxUgSAKi}Live Stock Animals", (Dictionary<string, object>)null);
		_textItems = new TextObject("{=U7er3V9s}Items", (Dictionary<string, object>)null);
		_textBaseNavalCapacity = new TextObject("{=7Q8ufo5X}Ships", (Dictionary<string, object>)null);
	}
}

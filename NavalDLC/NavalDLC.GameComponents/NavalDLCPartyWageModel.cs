...
public class NavalDLCPartyWageModel : PartyWageModel
{
	...
	private readonly TextObject _partyWageReductionAtSea;
	...
	public override ExplainedNumber GetTotalWage(MobileParty mobileParty, TroopRoster troopRoster, bool includeDescriptions = false)
	{
		...
		{
			((ExplainedNumber)(ref totalWage)).AddFactor(-0.2f, _partyWageReductionAtSea);
	...
	public NavalDLCPartyWageModel()
	{
		...
		_convoyPartyWageCutText = new TextObject("{=lDxu6pez}Convoy Wage Multiplier", (Dictionary<string, object>)null);
		_partyWageReductionAtSea = new TextObject("{=sWhNhHkV}Wage Reduction At Sea", (Dictionary<string, object>)null);
		((PartyWageModel)this)._002Ector();
	}
}

...
public class NavalDLCMobilePartyFoodConsumptionModel : MobilePartyFoodConsumptionModel
{
	...
	private readonly TextObject _partyFoodConsumptionReductionAtSea;
	...
	public NavalDLCMobilePartyFoodConsumptionModel()
	{
		...
		_partyFoodConsumptionReductionAtSea = new TextObject("{=Z1af4yEX}Food Consumption Reduction At Sea", (Dictionary<string, object>)null);
		((MobilePartyFoodConsumptionModel)this)._002Ector();
	}
}

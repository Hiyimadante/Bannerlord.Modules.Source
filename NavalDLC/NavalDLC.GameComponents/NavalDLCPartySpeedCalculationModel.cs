...
public class NavalDLCPartySpeedCalculationModel : PartySpeedModel
{
	...
	private static readonly TextObject _riverEffect;
	...
	public override ExplainedNumber CalculateFinalSpeed(MobileParty mobileParty, ExplainedNumber finalSpeed)
	{
		...
		if (mobileParty.IsCurrentlyAtSea)
		{
			...
			if (((List<Ship>)(object)mobileParty.Ships).Count > 0)
			{
				...
				{
					if (item.ShipHull.CanNavigateShallowWater)
					{
	...
	static NavalDLCPartySpeedCalculationModel()
	{
		...
		_textOverburdened = new TextObject("{=xgO3cCgR}Overburdened", (Dictionary<string, object>)null);
		_textOverFleetSize = new TextObject("{=D3OvWCpp}Over fleet size", (Dictionary<string, object>)null);
		_textDisorganized = new TextObject("{=JuwBb2Yg}Disorganized", (Dictionary<string, object>)null);
		_textShallowDraftPenalty = new TextObject("{=RU7pNBts}Shallow Draft", (Dictionary<string, object>)null);
		_openSeaEffect = new TextObject("{=KzEFMlfZ}Open Sea", (Dictionary<string, object>)null);
		_riverEffect = new TextObject("{=UvIsHvrt}River", (Dictionary<string, object>)null);
		_windEffect = new TextObject("{=lJDeXyt1}Wind", (Dictionary<string, object>)null);
		_gunnarEffect = new TextObject("{=LSVGrpMr}Gunnar's Skill", (Dictionary<string, object>)null);
	}
}

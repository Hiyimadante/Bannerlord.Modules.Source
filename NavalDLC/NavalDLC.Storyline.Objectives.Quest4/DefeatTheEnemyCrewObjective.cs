...
public class DefeatTheEnemyCrewObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=7OeuYDQS}Defeat the Enemy Crew", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=aImP2qRA}Defeat Crusas’ men in the battle aboard the floating fortress", (Dictionary<string, object>)null);
		}
	}

...
public class BoardFloatingFortressObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=UcZmBaYV}Storm the Floating Fortress", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=wCiAvXU6}Lead your fleet in to board Crusas’ lashed-together ships", (Dictionary<string, object>)null);
		}
	}

...
public class DestroyMangonelsObjective : MissionObjective
{
	...
	public override TextObject Name
	{
		get
		{
			...
			return new TextObject("{=ZpuppygP}Destroy the Mangonels", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Description
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=OrI07kdd}Steer the Wasp and destroy the mangonels with your ballista without getting hit yourself", (Dictionary<string, object>)null);
		}
	}

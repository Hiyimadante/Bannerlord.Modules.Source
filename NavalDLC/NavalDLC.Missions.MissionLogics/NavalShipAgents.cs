...
internal class NavalShipAgents
{
	...
	[CompilerGenerated]
	private TroopTraitsMask _003CTroopClassFilter_003Ek__BackingField;

	[CompilerGenerated]
	private TroopTraitsMask _003CTroopTraitsFilter_003Ek__BackingField;
	...
	public TroopTraitsMask TroopClassFilter
	{
		...
		get
		{
			...
			return _003CTroopClassFilter_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CTroopClassFilter_003Ek__BackingField = value;
		}
	}
	...
	public TroopTraitsMask TroopTraitsFilter
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CTroopTraitsFilter_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CTroopTraitsFilter_003Ek__BackingField = value;
		}
	}
	...
	internal bool SpawnReinforcements { get; private set; }
	...
	internal NavalShipAgents(MissionShip ship, NavalTeamAgents teamAgents)
	{
		...
		_activeHeroAgents = new MBList<Agent>();
		_activeNonHeroAgents = new MBList<Agent>();
		_reservedOrderedTroops = new MBSortedMultiList<int, NavalTroopAssignment>(true);
		_reservedTroops = new Dictionary<IAgentOriginBase, NavalTroopAssignment>();
	...
	{
		int num = 0;
		if (_reinforcementTimer.Check(true) && Ship?.Team != null && !Ship.IsShipNavmeshDisabled)
		{
	...
	internal void AssignAndTeleportCrewToShipMachines()
	{
		...
		if (Ship.Captain != null && ((UsableMachine)shipControllerMachine).PilotAgent != Ship.Captain && (Ship.Captain != Agent.Main || !Ship.HasPlayerStandingPointEntity) && (Ship.Captain.IsAIControlled ? (!((UsableMachine)shipControllerMachine).IsDisabledForAI) : (!((UsableMissionObject)((UsableMachine)shipControllerMachine).PilotStandingPoint).IsDisabledForPlayers)))
		{
	...
	private Agent SpawnAgentAux(IAgentOriginBase agentOrigin, bool isReinforcement)
	{
		...
		bool flag = Ship.BattleSide == Mission.Current.PlayerTeam.Side;
		Agent val = Mission.Current.SpawnTroop(agentOrigin, flag, true, false, false, 0, 0, true, true, (Vec3?)crewSpawnGlobalFrame.origin, (Vec2?)value, (string)null, (ItemObject)null, Ship.FormationIndex, false);
		bool flag2 = false;

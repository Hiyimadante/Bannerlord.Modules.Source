...
{
	private readonly ActionIndexCache _breakChainsShortAction;
	...
	protected override void OnTick(float dt)
	{
		...
		{
			((UsableMachine)this).PilotAgent.StopUsingGameObject(true, (StopUsingGameObjectFlags)1);
			val.MakeVoice(VoiceType.MpThanks, (CombatVoiceNetworkPredictionType)2);
		}
	}
	...
	public AgentBindsMachine()
	{
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		//IL_000b: Unknown result type (might be due to invalid IL or missing references)
		_breakChainsShortAction = ActionIndexCache.Create("act_cutscene_break_chains_short");

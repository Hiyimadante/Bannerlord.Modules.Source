...
public class ShipAttachmentPointMachine : UsableMachine
{
	...
	[CompilerGenerated]
	private Vec3 _003CHookAttachLocalPosition_003Ek__BackingField;

	private GameEntity _focusObject;

	private MBList<GameEntity> _rampPhysicsList;

	private ActionIndexCache _actionForJumpingOff;
	...
	public Vec3 HookAttachLocalPosition
	{
		...
		get
		{
			...
			return _003CHookAttachLocalPosition_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CHookAttachLocalPosition_003Ek__BackingField = value;
		}
	}
	...
	protected override void OnTick(float dt)
	{
		...
		bool flag = !OwnerShip.BeingAbandoned && (LinkedAttachmentMachine?.CurrentAttachment != null || CurrentAttachment == null || (((UsableMachine)this).PilotAgent == null && (CurrentAttachment.State != ShipAttachmentMachine.ShipAttachment.ShipAttachmentState.BridgeConnected || OwnerShip.IsDisconnectionBlocked())));
		...
		if (OwnerShip.BeingAbandoned)
		{
			...
			if (!(((UsableMachine)this).PilotAgent.GetCurrentAction(0) != _actionForJumpingOff))
			{
				return;
			}
			MatrixFrame frame = ((UsableMachine)this).PilotAgent.Frame;
			Vec2 asVec = ((Vec3)(ref frame.origin)).AsVec2;
			if (!(((Vec2)(ref asVec)).DistanceSquared(((WorldPosition)(ref userFrameForAgent.Origin)).AsVec2) <= 0.3f))
			{
				return;
			}
			frame = ((UsableMachine)this).PilotAgent.Frame;
			if (Vec3.DotProduct(((Vec3)(ref frame.rotation.f)).NormalizedCopy(), f) > 0.95f)
			{
				...
				Vec3 val = pilotAgent.Position + f * 10f;
				pilotAgent.GetComponent<AgentNavalComponent>().SetupAgentToAbandonShip();
				pilotAgent.SetActionChannel(0, ref _actionForJumpingOff, false, (AnimFlags)0, 0f, 1f, -0.2f, 0.4f, 0f, false, -0.2f, 0, true);
	...
	public ShipAttachmentPointMachine()
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		_actionForJumpingOff = ActionIndexCache.act_escape_jump;

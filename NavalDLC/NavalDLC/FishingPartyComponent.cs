...
public class FishingPartyComponent : VillagerPartyComponent
{
	...
	[CompilerGenerated]
	private CampaignTime _003CFishingWaitStartTime_003Ek__BackingField;

	[CompilerGenerated]
	private CampaignTime _003CRoamingStartTime_003Ek__BackingField;
	...
	public CampaignTime FishingWaitStartTime
	{
		...
		get
		{
			...
			return _003CFishingWaitStartTime_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CFishingWaitStartTime_003Ek__BackingField = value;
		}
	}
	...
	public CampaignTime RoamingStartTime
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CRoamingStartTime_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CRoamingStartTime_003Ek__BackingField = value;
		}
	}
	...
	protected override void OnMobilePartySetOnCreation()
	{
		...
		CampaignVec2 portPosition = ((SettlementComponent)((VillagerPartyComponent)this).Village).Settlement.PortPosition;
		((PartyComponent)this).MobileParty.InitializeMobilePartyAroundPosition(fishingPartyTemplate, portPosition, 1f, 0f);

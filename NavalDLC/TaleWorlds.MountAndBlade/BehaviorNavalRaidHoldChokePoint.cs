...
public class BehaviorNavalRaidHoldChokePoint : BehaviorComponent
{
	...
	public override void TickOccasionally()
	{
		...
		if ((int)((BehaviorComponent)this).Formation.GetUnderAttackTypeOfUnits(5f) == 1)
		{
			((BehaviorComponent)this).Formation.SetArrangementOrder(ArrangementOrder.ArrangementOrderLine);
		}
		else
		{
			((BehaviorComponent)this).Formation.SetArrangementOrder(ArrangementOrder.ArrangementOrderShieldWall);
		}
	}

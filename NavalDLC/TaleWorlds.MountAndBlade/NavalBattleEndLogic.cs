...
public class NavalBattleEndLogic : MissionLogic, IBattleEndLogic
{
	...
	private void OnMissionEnd()
	{
		...
		foreach (MissionShip item4 in (List<MissionShip>)(object)_navalShipsLogic.AllShips)
		{
			...
			Ship shipToCapture;
			if ((shipToCapture = (Ship)(object)((shipOrigin is Ship) ? shipOrigin : null)) != null && LinQuick.ContainsQ<MapEventParty>((List<MapEventParty>)(object)val3, (Func<MapEventParty, bool>)((MapEventParty x) => x.Party == shipToCapture.Owner)))
			{

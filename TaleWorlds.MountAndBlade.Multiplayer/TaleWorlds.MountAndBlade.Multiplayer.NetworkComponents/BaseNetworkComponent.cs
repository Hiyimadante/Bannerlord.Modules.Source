...
public class BaseNetworkComponent : UdpNetworkComponent
{
	...
	[CompilerGenerated]
	private MultiplayerIntermissionState _003CClientIntermissionState_003Ek__BackingField;
	...
	public MultiplayerIntermissionState ClientIntermissionState
	{
		...
		get
		{
			...
			return _003CClientIntermissionState_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CClientIntermissionState_003Ek__BackingField = value;
		}
	}
	...
	private void HandleServerEventMultiplayerOptionsInitial(GameNetworkMessage baseMessage)
	{
		...
		{
			WelcomeMessageReceived?.Invoke(strValue);
		}
	}

	...
	public static void OpenTeamDeathmatchMission(string scene)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val2 = delegate
			{
				...
				//IL_00d3: Unknown result type (might be due to invalid IL or missing references)
				//IL_00d9: Expected O, but got Unknown
				return (IEnumerable<MissionBehavior>)(object)((!GameNetwork.IsServer) ? new MissionBehavior[21]
				{
					(MissionBehavior)MissionLobbyComponent.CreateBehavior(),
					(MissionBehavior)new MissionMultiplayerTeamDeathmatchClient(),
					(MissionBehavior)new MultiplayerAchievementComponent(),
	...
	public static void OpenDuelMission(string scene)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val2 = delegate
			{
				...
				//IL_00ca: Unknown result type (might be due to invalid IL or missing references)
				//IL_00d0: Expected O, but got Unknown
				return (IEnumerable<MissionBehavior>)(object)((!GameNetwork.IsServer) ? new MissionBehavior[20]
				{
					(MissionBehavior)MissionLobbyComponent.CreateBehavior(),
					(MissionBehavior)new MissionMultiplayerGameModeDuelClient(),
					(MissionBehavior)new MultiplayerAchievementComponent(),
	...
	public static void OpenSiegeMission(string scene)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val3 = delegate
			{
				...
				//IL_00dc: Unknown result type (might be due to invalid IL or missing references)
				//IL_00e2: Expected O, but got Unknown
				return (IEnumerable<MissionBehavior>)(object)((!GameNetwork.IsServer) ? new MissionBehavior[22]
				{
					(MissionBehavior)MissionLobbyComponent.CreateBehavior(),
					(MissionBehavior)new MultiplayerWarmupComponent(),
					(MissionBehavior)new MissionMultiplayerSiegeClient(),
	...
	public static void OpenCaptainMission(string scene)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val2 = delegate
			{
				...
				//IL_00ef: Unknown result type (might be due to invalid IL or missing references)
				//IL_00f5: Expected O, but got Unknown
				return (IEnumerable<MissionBehavior>)(object)((!GameNetwork.IsServer) ? new MissionBehavior[23]
				{
					(MissionBehavior)MissionLobbyComponent.CreateBehavior(),
					(MissionBehavior)new MultiplayerAchievementComponent(),
					(MissionBehavior)new MultiplayerWarmupComponent(),
	...
	public static void OpenSkirmishMission(string scene)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val2 = delegate
			{
				...
				//IL_00f8: Unknown result type (might be due to invalid IL or missing references)
				//IL_00fe: Expected O, but got Unknown
				return (IEnumerable<MissionBehavior>)(object)((!GameNetwork.IsServer) ? new MissionBehavior[24]
				{
					(MissionBehavior)MissionLobbyComponent.CreateBehavior(),
					(MissionBehavior)new MultiplayerAchievementComponent(),
					(MissionBehavior)new MultiplayerWarmupComponent(),

...
public class SiegeScoreboardData : IScoreboardData
{
	public ScoreboardHeader[] GetScoreboardHeaders()
	{
		...
		return (ScoreboardHeader[])(object)new ScoreboardHeader[8]
		{
			...
			new ScoreboardHeader("score", (Func<MissionPeer, string>)((MissionPeer missionPeer) => missionPeer.Score.ToString().ToString()), (Func<BotData, string>)((BotData bot) => bot.Score.ToString()))
		};
	}
}

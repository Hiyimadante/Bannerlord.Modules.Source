...
public class TalkToTheHeadmanTutorialQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLog
	{
		get
		{
			...
			return new TextObject("{=rinefpgo}You have arrived at the village. You can buy some food and hire some men to help hunt for the raiders. First go into the village and talk to the headman.", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _readyToGoLog
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=KhL2ctsi}You're ready to leave now. Talk to the headman again. He had said he has a task for you.", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _goBackToVillageMenuLog
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=awgBkdXx}You should go back to the village menu and make your preparations to go after the raiders, then find out about the task that the headman has for you.", (Dictionary<string, object>)null);
		}
	}
	...
	public TalkToTheHeadmanTutorialQuest(Hero headman)
	{
		...
		base._002Ector("talk_to_the_headman_tutorial_quest", null, CampaignTime.Never);
		_headman = headman;

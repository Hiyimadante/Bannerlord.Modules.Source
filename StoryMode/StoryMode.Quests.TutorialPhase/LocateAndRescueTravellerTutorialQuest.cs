...
public class LocateAndRescueTravellerTutorialQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLogText
	{
		get
		{
			...
			return new TextObject("{=JJo0i8an}Look around the village to find the party that captured the traveller whom the headman told you about.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=ACyYhA2s}Locate and Rescue Traveller", (Dictionary<string, object>)null);
		}
	}
	...
	public LocateAndRescueTravellerTutorialQuest()
	{
		...
		base._002Ector("locate_and_rescue_traveler_tutorial_quest", null, CampaignTime.Never);

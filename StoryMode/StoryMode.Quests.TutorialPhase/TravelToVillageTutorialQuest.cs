...
public class TravelToVillageTutorialQuest : StoryModeQuestBase
{
	...
	private TextObject _endQuestLog
	{
		get
		{
			...
			return new TextObject("{=7VFLb3Qj}You have arrived at the village.", (Dictionary<string, object>)null);
		}
	}
	...
	private bool news_about_raiders_condition()
	{
		...
		{
			return Enumerable.Contains(_refugeeParties, MobileParty.ConversationParty);
		}
		return false;
	}
	...
	{
		if (!StoryMode.StoryModePhases.TutorialPhase.Instance.IsCompleted && Settlement.CurrentSettlement == null && PlayerEncounter.EncounteredParty != null && args.MenuContext.GameMenu.StringId != "encounter_meeting" && args.MenuContext.GameMenu.StringId != "encounter" && Enumerable.Contains(_refugeeParties, PlayerEncounter.EncounteredMobileParty))
		{

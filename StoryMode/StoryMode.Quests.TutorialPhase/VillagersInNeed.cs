...
public class VillagersInNeed : StoryModeQuestBase
{
	...
	public override TextObject Title
	{
		get
		{
			...
			return new TextObject("{=Cv2W7aFu}Villagers in Need", (Dictionary<string, object>)null);
		}
	}
	...
	public VillagersInNeed()
	{
		...
		base._002Ector("talk_to_villagers_in_village_quest", null, CampaignTime.Never);
	...
	protected override void OnStartQuest()
	{
		...
		Extensions.GetRandomElementWithPredicate<Hero>(Hero.AllAliveHeroes, (Func<Hero, bool>)delegate(Hero t)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0008: Invalid comparison between Unknown and I4
			return (int)t.Occupation == 20 && t.Culture == _village.Culture;
		});
	}

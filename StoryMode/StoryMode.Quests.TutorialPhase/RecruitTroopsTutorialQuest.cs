...
public class RecruitTroopsTutorialQuest : StoryModeQuestBase
{
	...
	private TextObject _recruitTroopTaskStartLog
	{
		get
		{
			...
			return new TextObject("{=vCBuF6dq}Recruit 4 recruits. Click \"Recruit Troops\" option on village menu to recruit troops.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=y3fn2vWY}Recruit Troops", (Dictionary<string, object>)null);
		}
	}
	...
	public RecruitTroopsTutorialQuest(Hero questGiver)
	{
		...
		base._002Ector("recruit_troops_tutorial_quest", questGiver, CampaignTime.Never);

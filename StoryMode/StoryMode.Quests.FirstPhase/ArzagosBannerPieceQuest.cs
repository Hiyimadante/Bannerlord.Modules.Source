...
public class ArzagosBannerPieceQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLog
	{
		get
		{
			...
			return new TextObject("{=wvHvnEog}Find the hideout that Arzagos told you about and get the next banner piece.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=ay1gPPsP}Find Another Piece of the Banner for Arzagos", (Dictionary<string, object>)null);
		}
	}
	...
	public ArzagosBannerPieceQuest(Hero questGiver, Settlement hideout)
	{
		...
		base._002Ector("arzagos_banner_piece_quest", questGiver, StoryModeManager.Current.MainStoryLine.FirstPhase.FirstPhaseEndTime);
		_hideout = hideout;

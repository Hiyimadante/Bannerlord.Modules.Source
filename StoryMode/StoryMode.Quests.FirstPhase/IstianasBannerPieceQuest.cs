...
public class IstianasBannerPieceQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLog
	{
		get
		{
			...
			return new TextObject("{=GxlPj4GC}Find the hideout that Istiana told you about and get the next banner piece.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=WTjAYUoD}Find Another Piece of the Banner for Istiana", (Dictionary<string, object>)null);
		}
	}
	...
	public IstianasBannerPieceQuest(Hero questGiver, Settlement hideout)
	{
		...
		base._002Ector("istiana_banner_piece_quest", questGiver, StoryModeManager.Current.MainStoryLine.FirstPhase.FirstPhaseEndTime);
		_hideout = hideout;
	...
	protected override void SetDialogs()
	{
		...
		Campaign.Current.ConversationManager.AddDialogFlow(DialogFlow.CreateDialogFlow("hero_main_options", 100).PlayerLine(new TextObject("{=dlBFVkDj}About the task you gave me...", (Dictionary<string, object>)null), (OnMultipleConversationConsequenceDelegate)null, (string)null, (string)null).Condition(new OnConditionDelegate(conversation_lord_task_given_on_condition))
			.NpcLine(new TextObject("{=F26iH45g}What happened? Have you assembled the banner?", (Dictionary<string, object>)null), (OnMultipleConversationConsequenceDelegate)null, (OnMultipleConversationConsequenceDelegate)null, (string)null, (string)null)
	...
	private MobileParty CreateRaiderParty(int number)
	{
		...
		MobileParty obj = BanditPartyComponent.CreateBanditParty("istiana_banner_piece_quest_raider_party_" + number, hideoutClan, _hideout.Hideout, false, (PartyTemplateObject)null, _hideout.GatePosition);
	...
	{
		((MBObjectBase)(IstianasBannerPieceQuest)o).AutoGeneratedInstanceCollectObjects(collectedObjects);
	}

...
public class BannerInvestigationQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLog
	{
		get
		{
			...
			return new TextObject("{=ysRVZiA6}As you explore Calradia, you can learn more about your artifact and its importance by asking any lord or lady about the Empire's recent history.", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _endQuestLog
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=oA4iTPyV}You have collected enough information.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=zLRlmitp}Investigate 'Neretzes' Folly'", (Dictionary<string, object>)null);
		}
	}
	...
	public BannerInvestigationQuest()
	{
		...
		base._002Ector("investigate_neretzes_banner_quest", null, StoryModeManager.Current.MainStoryLine.FirstPhase.FirstPhaseEndTime);
	...
	protected override void SetDialogs()
	{
		...
		Campaign.Current.ConversationManager.AddDialogFlow(DialogFlow.CreateDialogFlow("hero_main_options", 150).BeginPlayerOptions((string)null, false).PlayerSpecialOption(new TextObject("{=qV1e0x8i}What is 'Neretzes' Folly'?", (Dictionary<string, object>)null), (OnMultipleConversationConsequenceDelegate)null, (string)null, (string)null)
			.Condition((OnConditionDelegate)delegate
			{
				...
				return Hero.OneToOneConversationHero != null && (int)CharacterObject.OneToOneConversationCharacter.Occupation == 3 && Hero.OneToOneConversationHero.Clan != Hero.MainHero.Clan && !_battleSummarized && !MobileParty.MainParty.IsInRaftState && (MobileParty.ConversationParty == null || !MobileParty.ConversationParty.IsInRaftState);
			})

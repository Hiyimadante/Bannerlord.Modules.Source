...
public class AssembleTheBannerQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLog
	{
		get
		{
			...
			return new TextObject("{=OS8YjyE5}You should collect all of the pieces of the Dragon Banner before deciding your path.", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _endQuestLog
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=eNJBjYG8}You successfully assembled the Dragon Banner of Calradios.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=y84UnOQX}Assemble the Dragon Banner", (Dictionary<string, object>)null);
		}
	}
	...
	public AssembleTheBannerQuest()
	{
		...
		base._002Ector("assemble_the_banner_story_mode_quest", null, StoryModeManager.Current.MainStoryLine.FirstPhase.FirstPhaseEndTime);

...
public class SupportKingdomQuest : StoryModeQuestBase
{
	...
	private TextObject _onPlayerRuledKingdomSupportedLogText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=kqj1Wp0f}You have decided to keep the Dragon Banner within the kingdom you are ruling.", (Dictionary<string, object>)null);
		}
	}
	...
	public SupportKingdomQuest(Hero questGiver)
	{
		...
		base._002Ector("main_storyline_support_kingdom_quest_" + ((StoryModeHeroes.ImperialMentor == questGiver) ? "1" : "0"), questGiver, StoryModeManager.Current.MainStoryLine.FirstPhase.FirstPhaseEndTime);

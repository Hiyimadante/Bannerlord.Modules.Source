...
public class RebuildPlayerClanQuest : StoryModeQuestBase
{
	...
	private static int _partySizeGoal => Campaign.Current.Models.BanditDensityModel.GetMinimumTroopCountForHideoutMission(MobileParty.MainParty, false);
	...
	private TextObject _goldGoalLogText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=bXYFXLgg}Increase your denars by 1000", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _partySizeGoalLogText
	{
		get
		{
			...
			val.SetTextVariable("PARTY_SIZE", _partySizeGoal);
			return val;
		}
	}
	...
	private TextObject _clanTierGoalLogText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=RbXiEdXk}Reach Clan Tier 1", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _hireCompanionGoalLogText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=e8Tjf8Ph}Hire 1 Companion", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _successLogText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=eJX7rhch}You have successfully rebuilt your clan.", (Dictionary<string, object>)null);
		}
	}
	...
	public override TextObject Title
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=bESRdcRo}Establish Your Clan", (Dictionary<string, object>)null);
		}
	}
	...
	public RebuildPlayerClanQuest()
	{
		...
		base._002Ector("rebuild_player_clan_storymode_quest", null, CampaignTime.Never);
		_finishQuest = false;
	...
	protected override void OnStartQuest()
	{
		...
		_partySizeGoalLog = ((QuestBase)this).AddDiscreteLog(_partySizeGoalLogText, new TextObject("{=DO4PE3Oo}Current Party Size", (Dictionary<string, object>)null), 1, _partySizeGoal, (TextObject)null, true);

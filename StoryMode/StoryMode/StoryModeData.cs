...
{
	private static HashSet<string> _conspiracyTroops;

	public static CampaignTime StorylineQuestHideoutHiddenDuration;
	...
	static StoryModeData()
	{
		//IL_0177: Unknown result type (might be due to invalid IL or missing references)
		//IL_017c: Unknown result type (might be due to invalid IL or missing references)
		_conspiracyTroops = new HashSet<string>
		{
		...
		StorylineQuestHideoutHiddenDuration = CampaignTime.Hours(12f);
	}
}

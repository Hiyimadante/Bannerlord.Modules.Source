...
public class DefeatTheConspiracyQuestBehavior : CampaignBehaviorBase
{
	internal class OppositionData
	{
		...
		public OppositionData()
		{
			...
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			LastPeaceOfferDate = CampaignTime.Zero;
			base._002Ector();
		}
	}
	...
	public class DefeatTheConspiracyQuest : StoryModeQuestBase
	{
		...
		private TextObject _defeatOpposingKingdomsQuestLogText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=ib2TKPUa}The ruler of the {FACTION} is leading the alliance against you. Defeat their armies or force them to make peace by capturing their settlements and destroying their parties to achieve victory.", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _defeatOpposingKingdomsProgressLogText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=3Io5vmOk}War Progress with the {FACTION}", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _imperialKingdomDefeatedPopUpTitleText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=XWL3XcIq}{FACTION} Defeated", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _imperialKingdomDefeatedPopUpDescriptionText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=4SnDe0rA}The clans of the {FACTION} have defected to surrounding kingdoms as their leader has given up all hopes of restoring the Empire.", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _imperialKingdomDefeatedQuestLogText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=OwcgxRXB}Weakened by the war, the {FACTION} has collapsed and its clans have defected to surrounding kingdoms.", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _antiImperialKingdomDefeatedPopUpTitleText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=L3Qb6lbp}Peace Offer from the {FACTION}", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _antiImperialKingdomDefeatedPopUpKingDescriptionText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=E87miqTI}Exhausted from the war, the clans of the {FACTION} offer to make peace with the {PLAYER_SUPPORTED_FACTION}.", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _antiImperialKingdomDefeatedPopUpSubjectDescriptionText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=hGPdLssq}The ruler of the {PLAYER_SUPPORTED_FACTION} has accepted the peace offered by the war-ravaged {FACTION}.", (Dictionary<string, object>)null);
			}
		}
		...
		private TextObject _antiImperialKingdomDefeatedQuestLogText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=weS3DJKA}Weakened by war, the ruler of the {FACTION} offers to make peace with {PLAYER_FACTION}.", (Dictionary<string, object>)null);
			}
		}
		...
		public DefeatTheConspiracyQuest(string questId, Kingdom oppositionKingdom)
		{
			...
			base._002Ector(questId, StoryModeManager.Current.MainStoryLine.IsOnImperialQuestLine ? StoryModeHeroes.ImperialMentor : StoryModeHeroes.AntiImperialMentor, CampaignTime.Never);
	...
	private TextObject _empireUnitedText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=zTYd6Qai}The Empire has been united under the {FACTION}!", (Dictionary<string, object>)null);
		}
	}
	...
	private TextObject _empireDefeatedText
	{
		get
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Expected O, but got Unknown
			return new TextObject("{=rCX81DDR}The Empire has been destroyed!", (Dictionary<string, object>)null);
		}
	}
	...
	protected void InitializeFinalPhase()
	{
		...
		foreach (KeyValuePair<Kingdom, int> item3 in dictionary)
		{
			...
			{
				bool flag = false;
				if (val3 == null || ((List<Hero>)(object)val3.AliveLords).Count >= val3.WarPartyLimit)
				{
				...
				Hero val6 = HeroCreator.CreateSpecialHero(((((List<MobileParty>)(object)val).Count > 0) ? Extensions.GetRandomElement<MobileParty>(val).LeaderHero : Extensions.GetRandomElementWithPredicate<Hero>(Hero.AllAliveHeroes, (Func<Hero, bool>)delegate(Hero t)
				{
					//IL_0001: Unknown result type (might be due to invalid IL or missing references)
					//IL_0007: Invalid comparison between Unknown and I4
					return (int)t.Occupation == 3 && t.Culture == kingdom.Culture;
				})).CharacterObject, val5, val3, (Clan)null, -1);

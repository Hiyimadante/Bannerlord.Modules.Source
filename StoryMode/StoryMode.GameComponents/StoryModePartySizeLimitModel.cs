...
public class StoryModePartySizeLimitModel : PartySizeLimitModel
{
	...
	public override ExplainedNumber GetPartyMemberSizeLimit(PartyBase party, bool includeDescriptions = false)
	{
		...
		if (party.IsMobile)
		{
			QuestBase val = ((IEnumerable<QuestBase>)Campaign.Current.QuestManager.Quests).FirstOrDefault((QuestBase q) => !q.IsFinalized && ((object)q).GetType() == typeof(DisruptSupplyLinesConspiracyQuest));
			if (val != null)
			{

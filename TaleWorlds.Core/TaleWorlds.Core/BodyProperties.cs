...
public struct BodyProperties
{
	...
	{
		return (unchecked(2041866711 * -1521134295) + EqualityComparer<DynamicBodyProperties>.Default.GetHashCode(_dynamicBodyProperties)) * -1521134295 + EqualityComparer<StaticBodyProperties>.Default.GetHashCode(_staticBodyProperties);
	}

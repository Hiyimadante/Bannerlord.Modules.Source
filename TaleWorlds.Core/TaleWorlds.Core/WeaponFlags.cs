...
public enum WeaponFlags : ulong
{
	MeleeWeapon = 1uL,
	RangedWeapon = 2uL,
	WeaponMask = MeleeWeapon | RangedWeapon,
	FirearmAmmo = 4uL,
	NotUsableWithOneHand = 0x10uL,
	NotUsableWithTwoHand = 0x20uL,
	HandUsageMask = NotUsableWithOneHand | NotUsableWithTwoHand,
	WideGrip = 0x40uL,
	AttachAmmoToVisual = 0x80uL,
	Consumable = 0x100uL,
	HasHitPoints = 0x200uL,
	DataValueMask = Consumable | HasHitPoints,
	HasString = 0x400uL,
	...
	AmmoBreakOnBounceBackMask = AmmoBreaksOnBounceBack | AmmoCanBreakOnBounceBack,

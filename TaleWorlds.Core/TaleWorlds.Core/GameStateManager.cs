...
public class GameStateManager
{
	...
	private struct GameStateJob(GameStateJob.JobType job, GameState gameState, int popLevel)
	{
		public enum JobType
		{
			None,
		...
		public readonly JobType Job = job;

		public readonly GameState GameState = gameState;

		public readonly int PopLevel = popLevel;
	}

...
public class SPOrderOfBattleVM : OrderOfBattleVM
{
	...
	public SPOrderOfBattleVM()
	{
		...
		_captainPerksText = new TextObject("{=pgXuyHxH}Captain Perks", (Dictionary<string, object>)null);
		_infantryInfluenceText = new TextObject("{=SSLUHH6j}Infantry Influence", (Dictionary<string, object>)null);
		_rangedInfluenceText = new TextObject("{=0DMM0agr}Ranged Influence", (Dictionary<string, object>)null);
		_cavalryInfluenceText = new TextObject("{=X8i3jZn8}Cavalry Influence", (Dictionary<string, object>)null);
		_horseArcherInfluenceText = new TextObject("{=gZIOG0wl}Horse Archer Influence", (Dictionary<string, object>)null);
		_noPerksText = new TextObject("{=7yaDnyKb}There is no additional perk influence.", (Dictionary<string, object>)null);
		_perkComparer = new PerkObjectComparer();
		((OrderOfBattleVM)this)._002Ector();
	...
	protected override void LoadConfiguration()
	{
		...
		if (_orderOfBattleBehavior == null || !((OrderOfBattleVM)this).IsPlayerGeneral)
		{
			return;
		}
		for (int i = 0; i < ((OrderOfBattleVM)this).TotalFormationCount; i++)
		{
			OrderOfBattleFormationData formationInfo = _orderOfBattleBehavior.GetFormationDataAtIndex(i, Mission.Current.IsSiegeBattle, MobileParty.MainParty.Army != null);
			if (formationInfo != null && (int)formationInfo.FormationClass != 0)
			{
				...
				if ((int)formationInfo.FormationClass == 1)
				{
					...
					((Collection<OrderOfBattleFormationClassVM>)(object)base._allFormations[i].Classes)[1].Class = (FormationClass)10;
				}
				...
				if (flag)
				{
					...
					((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)base._allFormations[i].FilterItems).FirstOrDefault(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
					{
						//IL_0001: Unknown result type (might be due to invalid IL or missing references)
						//IL_0007: Invalid comparison between Unknown and I4
						return (int)f.FilterType == 1;
					}).IsActive = value;
					((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)base._allFormations[i].FilterItems).FirstOrDefault(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
					{
						//IL_0001: Unknown result type (might be due to invalid IL or missing references)
						//IL_0007: Invalid comparison between Unknown and I4
						return (int)f.FilterType == 2;
					}).IsActive = value2;
					((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)base._allFormations[i].FilterItems).FirstOrDefault(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
					{
						//IL_0001: Unknown result type (might be due to invalid IL or missing references)
						//IL_0007: Invalid comparison between Unknown and I4
						return (int)f.FilterType == 3;
					}).IsActive = value3;
					((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)base._allFormations[i].FilterItems).FirstOrDefault(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
					{
						//IL_0001: Unknown result type (might be due to invalid IL or missing references)
						//IL_0007: Invalid comparison between Unknown and I4
						return (int)f.FilterType == 4;
					}).IsActive = value4;
					((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)base._allFormations[i].FilterItems).FirstOrDefault(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
					{
						//IL_0001: Unknown result type (might be due to invalid IL or missing references)
						//IL_0007: Invalid comparison between Unknown and I4
						return (int)f.FilterType == 5;
					}).IsActive = value5;
					((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)base._allFormations[i].FilterItems).FirstOrDefault(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
					{
						//IL_0001: Unknown result type (might be due to invalid IL or missing references)
						//IL_0007: Invalid comparison between Unknown and I4
						return (int)f.FilterType == 6;
					}).IsActive = value6;
				}
				else
				{
				...
				{
					OrderOfBattleHeroItemVM val2 = base._allHeroes.FirstOrDefault((OrderOfBattleHeroItemVM c) => (object)c.Agent.Character == formationInfo.Captain.CharacterObject);
					if (val2 != null)
					{
				...
				{
					OrderOfBattleHeroItemVM val3 = base._allHeroes.FirstOrDefault((OrderOfBattleHeroItemVM ht) => (object)ht.Agent.Character == heroTroop.CharacterObject);
					if (val3 != null)
					{
		...
		{
			OrderOfBattleFormationData formationDataAtIndex = _orderOfBattleBehavior.GetFormationDataAtIndex(num2, Mission.Current.IsSiegeBattle, MobileParty.MainParty.Army != null);
	...
	protected override void SaveConfiguration()
	{
		...
		if (_orderOfBattleBehavior != null && !(((OrderOfBattleVM)this).IsPlayerGeneral & flag))
		{
			return;
		}
		...
		for (int i = 0; i < ((OrderOfBattleVM)this).TotalFormationCount; i++)
		{
			...
			Hero[] array = (from ht in (IEnumerable<OrderOfBattleHeroItemVM>)formationItemVM.HeroTroops
			...
			list.Add(new OrderOfBattleFormationData(val, array, orderOfBattleClass, num, num2, dictionary));
		}
	...
	static SPOrderOfBattleVM()
	{
		...
		_perkDefinitionText = new TextObject("{=jCdZY3i4}{PERK_NAME} ({SKILL_LEVEL} - {SKILL})", (Dictionary<string, object>)null);
	}
}

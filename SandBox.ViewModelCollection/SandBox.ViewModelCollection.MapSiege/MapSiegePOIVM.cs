...
public class MapSiegePOIVM : ViewModel
{
	...
	[CompilerGenerated]
	private MatrixFrame _003CMapSceneLocationFrame_003Ek__BackingField;
	...
	public MatrixFrame MapSceneLocationFrame
	{
		...
		get
		{
			...
			return _003CMapSceneLocationFrame_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CMapSceneLocationFrame_003Ek__BackingField = value;
		}
	}
	...
	public void RefreshPosition()
	{
		...
		if (!MathF.IsValidValue(_latestX) || !MathF.IsValidValue(_latestY) || !MathF.IsValidValue(_latestW))
		{
			_latestX = -10000f;
			_latestY = -10000f;
			_latestW = -1f;

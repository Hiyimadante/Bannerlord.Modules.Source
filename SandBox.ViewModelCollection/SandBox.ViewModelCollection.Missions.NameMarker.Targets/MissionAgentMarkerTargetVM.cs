...
public class MissionAgentMarkerTargetVM : MissionNameMarkerTargetVM<Agent>
{
	...
	public void UpdateQuestStatus()
	{
		...
		{
			if ((int)questFlag != 0 && (val & questFlag) != 0 && LinQuick.AllQ<QuestMarkerVM>((IReadOnlyList<QuestMarkerVM>)base.Quests, (Func<QuestMarkerVM, bool>)delegate(QuestMarkerVM q)
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				//IL_0007: Unknown result type (might be due to invalid IL or missing references)
				return q.IssueQuestFlag != questFlag;
			}))
			{

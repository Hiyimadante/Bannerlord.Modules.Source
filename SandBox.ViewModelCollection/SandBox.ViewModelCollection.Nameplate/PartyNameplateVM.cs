...
public class PartyNameplateVM : NameplateVM
{
	...
	public static string AllianceIndicator;

	public static string AllianceArmyIndicator;
	...
	public override void RefreshPosition()
	{
		...
		if (mapEvent != null)
		{
			...
			if (((mapEventSettlement != null) ? new bool?(mapEventSettlement.IsVillage) : ((bool?)null)) == true && Party.IsCurrentlyAtSea)
			{
				val = Party.MapEvent.MapEventSettlement.GatePosition;
				val2 = ((CampaignVec2)(ref val)).AsVec3();
				val2 += new Vec3(RandomOwnerExtensions.RandomFloatWithSeed((IRandomOwner)(object)Party, (uint)Party.RandomValue, -0.3f, 0.3f), RandomOwnerExtensions.RandomFloatWithSeed((IRandomOwner)(object)Party, (uint)Party.RandomValue, -0.3f, 0.3f), 0f, -1f);
			}
		}
	...
	static PartyNameplateVM()
	{
		...
		PositiveIndicator = ((object)Color.FromUint(4285650500u)/*cast due to constrained. prefix*/).ToString();
		PositiveArmyIndicator = ((object)Color.FromUint(4288804731u)/*cast due to constrained. prefix*/).ToString();
		NegativeIndicator = ((object)Color.FromUint(4292232774u)/*cast due to constrained. prefix*/).ToString();
		NegativeArmyIndicator = ((object)Color.FromUint(4294931829u)/*cast due to constrained. prefix*/).ToString();
		NeutralIndicator = ((object)Color.FromUint(4291877096u)/*cast due to constrained. prefix*/).ToString();
		NeutralArmyIndicator = ((object)Color.FromUint(4294573055u)/*cast due to constrained. prefix*/).ToString();
		MainPartyIndicator = ((object)Color.FromUint(4287421380u)/*cast due to constrained. prefix*/).ToString();
		MainPartyArmyIndicator = ((object)Color.FromUint(4289593317u)/*cast due to constrained. prefix*/).ToString();
		AllianceIndicator = ((object)Color.FromUint(4279460044u)/*cast due to constrained. prefix*/).ToString();
		AllianceArmyIndicator = ((object)Color.FromUint(4279476684u)/*cast due to constrained. prefix*/).ToString();
	}
}

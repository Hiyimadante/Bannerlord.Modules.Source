...
public class MissionGauntletMultiplayerEscapeMenu : MissionGauntletEscapeMenuBase
{
	...
	protected override List<EscapeMenuItemVM> GetEscapeMenuItems()
	{
		...
		if ((int)((MissionBehavior)this).Mission.CurrentState == 2 && ((MissionBehavior)this).Mission.GetMissionEndTimerValue() < 0f && ((GameNetwork.IsMyPeerReady && GameNetwork.MyPeer.IsAdmin) || GameNetwork.IsServer))
		{

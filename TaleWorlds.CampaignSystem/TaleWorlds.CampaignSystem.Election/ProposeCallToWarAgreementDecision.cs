...
public class ProposeCallToWarAgreementDecision : KingdomDecision
{
	...
	public override float DetermineSupport(Clan clan, DecisionOutcome possibleOutcome)
	{
		...
		float scoreOfCallingToWar = Campaign.Current.Models.AllianceModel.GetScoreOfCallingToWar(base.Kingdom, CalledKingdom, KingdomToCallToWarAgainst, clan, out var _);

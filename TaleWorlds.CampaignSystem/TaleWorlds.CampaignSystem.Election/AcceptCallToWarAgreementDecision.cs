...
public class AcceptCallToWarAgreementDecision : KingdomDecision
{
	...
	public override float DetermineSupport(Clan clan, DecisionOutcome possibleOutcome)
	{
		...
		float scoreOfJoiningWar = Campaign.Current.Models.AllianceModel.GetScoreOfJoiningWar(CallingKingdom, base.Kingdom, KingdomToCallToWarAgainst, clan, out var _);

...
public class MakePeaceKingdomDecision : KingdomDecision
{
	...
	public override float DetermineSupport(Clan clan, DecisionOutcome possibleOutcome)
	{
		...
		float scoreOfDeclaringPeaceForClan = Campaign.Current.Models.DiplomacyModel.GetScoreOfDeclaringPeaceForClan(base.Kingdom, FactionToMakePeaceWith, clan, out var _);

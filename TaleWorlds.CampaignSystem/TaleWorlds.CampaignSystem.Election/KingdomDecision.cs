...
public abstract class KingdomDecision
{
	...
	public bool ShouldBeCancelled()
	{
		...
		DecisionOutcome decisionOutcome = DetermineSupportOption(new Supporter(ProposerClan), mBList, out var supportWeightOfSelectedOutcome, calculateRelationshipEffect: true);

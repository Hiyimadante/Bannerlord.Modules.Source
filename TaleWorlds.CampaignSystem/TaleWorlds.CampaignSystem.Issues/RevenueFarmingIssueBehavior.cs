...
public class RevenueFarmingIssueBehavior : CampaignBehaviorBase
{
	...
	public struct VillageEventOptionData(string text, GameMenuOption.OnConditionDelegate onCondition, GameMenuOption.OnConsequenceDelegate onConsequence, bool isLeave = false)
	{
		...
		public readonly GameMenuOption.OnConditionDelegate OnCondition = onCondition;

		public readonly GameMenuOption.OnConsequenceDelegate OnConsequence = onConsequence;

		public readonly bool IsLeave = isLeave;
	}

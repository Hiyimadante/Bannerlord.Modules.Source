...
public class ExtortionByDesertersIssueBehavior : CampaignBehaviorBase
{
	...
	{
		private readonly struct ExtortionByDesertersQuestResult(int renownChange, int honorChange, float goldMultiplier, int questGiverRelationChange, int questGiverPowerChange, int townSecurityChange, int townProsperityChange, bool isSuccess)
		{
			public readonly int RenownChange = renownChange;

			public readonly int HonorChange = honorChange;

			public readonly float GoldMultiplier = goldMultiplier;

			public readonly int QuestGiverRelationChange = questGiverRelationChange;

			public readonly int QuestGiverPowerChange = questGiverPowerChange;

			public readonly int TownSecurityChange = townSecurityChange;

			public readonly int TownProsperityChange = townProsperityChange;

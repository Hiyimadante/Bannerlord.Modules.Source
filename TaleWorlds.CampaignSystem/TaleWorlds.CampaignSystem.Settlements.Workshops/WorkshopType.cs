...
public sealed class WorkshopType : MBObjectBase
{
	...
	{
		private MBList<(ItemCategory, int)> _inputs = new MBList<(ItemCategory, int)>();

		private MBList<(ItemCategory, int)> _outputs = new MBList<(ItemCategory, int)>();

		private float _conversionSpeed = conversionSpeed;

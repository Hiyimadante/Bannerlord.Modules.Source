...
public class DefaultEncyclopediaShipPage : EncyclopediaPage
{
	...
	protected override IEnumerable<EncyclopediaFilterGroup> InitializeFilterItems()
	{
		...
		{
			new EncyclopediaFilterItem(new TextObject("{=bXJLb0BE}Hybrid"), (object s) =>
			{
				MissionShipObject ship;
				return s is ShipHull shipHull && (ship = MBObjectManager.Instance.GetObject<MissionShipObject>(shipHull.MissionShipObjectId)) != null && HasSailOfType(ship, SailType.Square) && HasSailOfType(ship, SailType.Lateen);
			}),

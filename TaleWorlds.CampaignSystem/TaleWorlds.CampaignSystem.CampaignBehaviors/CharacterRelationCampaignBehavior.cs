...
public class CharacterRelationCampaignBehavior : CampaignBehaviorBase
{
	...
	private void OnHeroKilled(Hero victim, Hero killer, KillCharacterAction.KillCharacterActionDetail detail, bool showNotification = true)
	{
		...
		foreach (Clan item in Clan.All)
		{
			...
			int relationChangeForExecutingHero = Campaign.Current.Models.ExecutionRelationModel.GetRelationChangeForExecutingHero(victim, item.Leader, out var showQuickNotification);

...
public class EncounterGameMenuBehavior : CampaignBehaviorBase
{
	...
	private bool game_menu_request_meeting_someone_on_condition(MenuCallbackArgs args)
	{
		...
		MenuHelper.SetIssueAndQuestDataForLocations(args, locations);
		bool result = Campaign.Current.Models.SettlementAccessModel.IsRequestMeetingOptionAvailable(Settlement.CurrentSettlement, out var disableOption, out var disabledText);
	...
	{
		string meetingScene = GetMeetingScene(out var sceneLevel);

...
public class LordConversationsCampaignBehavior : CampaignBehaviorBase
{
	...
	{
		bool num = FactionHelper.CanPlayerOfferMercenaryService((Kingdom)Hero.OneToOneConversationHero.MapFaction, out var playerWars, out var warsOfFactionToJoin);
		if (!num)
		{
	...
	{
		bool num = FactionHelper.CanPlayerOfferVassalage((Kingdom)Hero.OneToOneConversationHero.MapFaction, out var playerWars, out var warsOfFactionToJoin);
		if (!num)
		{

...
public class AllianceCampaignBehavior : CampaignBehaviorBase, IAllianceCampaignBehavior
{
	...
	{
		[SaveableField(0)]
		public readonly Kingdom Kingdom1 = kingdom1;

		[SaveableField(1)]
		public readonly Kingdom Kingdom2 = kingdom2;

		[SaveableField(2)]
		public CampaignTime EndTime = endTime;
	...
	internal struct CallToWarAgreement(Kingdom callingKingdom, Kingdom calledKingdom, Kingdom kingdomToCallToWarAgainst, CampaignTime endTime)
	{
		[SaveableField(0)]
		public readonly Kingdom CallingKingdom = callingKingdom;

		[SaveableField(1)]
		public readonly Kingdom CalledKingdom = calledKingdom;

		[SaveableField(2)]
		public readonly Kingdom KingdomToCallToWarAgainst = kingdomToCallToWarAgainst;

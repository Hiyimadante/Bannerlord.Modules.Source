...
public class EducationCampaignBehavior : CampaignBehaviorBase, IEducationLogic
{
	...
	{
		public readonly CharacterObject Character = character;

		public readonly Equipment Equipment = equipment;

		public readonly string ActionId = actionId;

		public readonly string PrefabId = prefabId;

		public readonly bool UseOffHand = useOffHand;
	...
	{
		ChildAgeState state = ((!_previousEducations.TryGetValue(child, out var value) || value == -1) ? GetClosestStage(child) : ((ChildAgeState)(value + 1)));

...
public class TradeSkillCampaignBehavior : CampaignBehaviorBase, IPlayerTradeBehavior
{
	...
	internal struct ItemTradeData(float averagePrice, int numItemsPurchased)
	{
		[SaveableField(10)]
		public readonly float AveragePrice = averagePrice;

		[SaveableField(20)]
		public readonly int NumItemsPurchased = numItemsPurchased;

...
{
	public struct VolunteerTroop(Hero ownerNotable, int notableVolunteerArrayIndex) : IComparable
	{
		public Hero OwnerNotable = ownerNotable;

		public int NotableVolunteerArrayIndex = notableVolunteerArrayIndex;

		public int Wage = Campaign.Current.Models.PartyWageModel.GetCharacterWage(ownerNotable.VolunteerTypes[notableVolunteerArrayIndex]);

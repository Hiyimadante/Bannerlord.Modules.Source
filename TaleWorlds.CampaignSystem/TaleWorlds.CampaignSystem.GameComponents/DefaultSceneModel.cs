...
public class DefaultSceneModel : SceneModel
{
	...
	{
		List<TerrainType> environmentTerrainTypesCount = Campaign.Current.MapSceneWrapper.GetEnvironmentTerrainTypesCount(in campaignPosition, out var currentPositionTerrainType);

...
{
	private struct NotablePowerRank(TextObject name, int minPowerValue, float influenceBonus)
	{
		public readonly TextObject Name = name;

		public readonly int MinPowerValue = minPowerValue;

		public readonly float InfluenceBonus = influenceBonus;
	}

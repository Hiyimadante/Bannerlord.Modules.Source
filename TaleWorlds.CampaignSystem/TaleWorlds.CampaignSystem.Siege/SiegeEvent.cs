	...
	public void BombardTick(ISiegeEventSide siegeEventSide)
	{
		...
		for (int i = 0; i < siegeEventSide.SiegeEngineMissiles.Count; i++)
		{
			...
			case SiegeBombardTargets.RangedEngines:
			{
				...
				else if (targetSiegeEngine != null && targetSiegeEngine != siegeEngineConstructionProgress && ((Enumerable.Contains(siegeEngines.DeployedRangedSiegeEngines, targetSiegeEngine) && targetSiegeEngine.IsActive) || siegeEngines.ReservedSiegeEngines.Contains(targetSiegeEngine)))
				{

...
public class MapCameraView : MapView
{
	...
	[CompilerGenerated]
	private Vec3 _003CIdealCameraTarget_003Ek__BackingField;
	...
	protected virtual Vec3 IdealCameraTarget
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CIdealCameraTarget_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CIdealCameraTarget_003Ek__BackingField = value;
		}
	}
	...
	public virtual void OnBeforeTick(in InputInformation inputInformation)
	{
		...
		if (inputInformation.IsMainPartyValid)
		{
			...
			if (!inputInformation.IsInMenu && !inputInformation.MiddleMouseButtonDown && (MobileParty.MainParty == null || MobileParty.MainParty.Army == null || MobileParty.MainParty.Army.LeaderParty == MobileParty.MainParty) && (inputInformation.PartyMoveRightKey || inputInformation.PartyMoveLeftKey || inputInformation.PartyMoveUpKey || inputInformation.PartyMoveDownKey))
			{
				...
				if (NavigationHelper.CanPlayerNavigateToPosition(val3, ref val4))
				{
	...
	protected virtual bool GetMapCameraInput(InputInformation inputInformation)
	{
		...
		if (CurrentCameraFollowMode == CameraFollowMode.FollowParty && cameraFollowParty != null && cameraFollowParty.IsValid)
		{
			...
			{
				object obj = cameraFollowParty.MobileParty.CurrentSettlement;
				if (obj == null)
				{
					obj = cameraFollowParty.MobileParty.BesiegedSettlement;
					if (obj == null)
					{
						MapEvent mapEvent = cameraFollowParty.MapEvent;
						obj = ((mapEvent != null) ? mapEvent.MapEventSettlement : null);
					}
				}
				Settlement val13 = (Settlement)obj;
				if (val13 != null && cameraFollowParty.MobileParty.IsMainParty)
				{
					val14 = val13.Position;
					val15 = ((CampaignVec2)(ref val14)).ToVec2();
					if (val13.HasPort)
					{
						CampaignVec2 portPosition = val13.PortPosition;
						val15 += ((CampaignVec2)(ref portPosition)).ToVec2();
						if (val13.IsUnderSiege)
						{
							Vec2 val16 = val15;
							val14 = val13.SiegeEvent.BesiegerCamp.LeaderParty.Position;
							val15 = val16 + ((CampaignVec2)(ref val14)).ToVec2();
							val15 /= 3f;
						}
						else
						{
				...
				else
				{
					...
					{
						val14 = cameraFollowParty.Position;
						val17 = ((CampaignVec2)(ref val14)).ToVec2();
					}
					else
					{
						val14 = cameraFollowParty.MapEvent.Position;
						val17 = ((CampaignVec2)(ref val14)).ToVec2();
					}
					val15 = val17;
				}
			...
			float num7 = 0f;
			IMapScene mapSceneWrapper = Campaign.Current.MapSceneWrapper;
			val14 = new CampaignVec2(val15, flag2);
			mapSceneWrapper.GetHeightAtPoint(ref val14, ref num7);
			IdealCameraTarget = new Vec3(((Vec2)(ref val15)).X, ((Vec2)(ref val15)).Y, num7 + 1f, -1f);
		}
		return result;
	}

...
public class MapConversationView : MapView
{
	public class MapConversationMission : ICampaignMission
	{
		...
		{
			public readonly string IdleActionId = idleActionId;

			public readonly string IdleFaceAnimId = idleFaceAnimId;

			public readonly string ReactionId = reactionId;

			public readonly string ReactionFaceAnimId = reactionFaceAnimId;

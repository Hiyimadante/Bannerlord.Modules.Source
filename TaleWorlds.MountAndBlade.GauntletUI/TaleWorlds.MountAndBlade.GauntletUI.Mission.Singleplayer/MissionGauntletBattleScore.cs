	...
	public override void OnMissionScreenTick(float dt)
	{
		...
		if (_forceScoreboardToggle || _dataSource.IsOver || _dataSource.IsMainCharacterDead || Input.IsGamepadActive)
		{
			if (CanOpenScoreboard())
			{
				...
				if (!_dataSource.ShowScoreboard)
				{
					MissionBehavior? obj = ((MissionBehavior)this).Mission.MissionBehaviors.FirstOrDefault((MissionBehavior behavior) => behavior is IBattleEndLogic);
		...
		if (CanOpenScoreboard())
		{
			...
			if (!_dataSource.ShowScoreboard)
			{
				MissionBehavior? obj3 = ((MissionBehavior)this).Mission.MissionBehaviors.FirstOrDefault((MissionBehavior behavior) => behavior is IBattleEndLogic);
		...
		{
			MissionBehavior? obj5 = ((MissionBehavior)this).Mission.MissionBehaviors.FirstOrDefault((MissionBehavior behavior) => behavior is IBattleEndLogic);
		...
		{
			MissionBehavior? obj7 = ((MissionBehavior)this).Mission.MissionBehaviors.FirstOrDefault((MissionBehavior behavior) => behavior is IBattleEndLogic);

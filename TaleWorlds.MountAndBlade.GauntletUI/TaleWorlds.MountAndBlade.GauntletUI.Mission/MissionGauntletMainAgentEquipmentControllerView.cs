...
public class MissionGauntletMainAgentEquipmentControllerView : MissionView
{
	...
	public override void OnFocusLost(Agent agent, IFocusable focusableObject)
	{
		...
		if (EquipHoldHandled)
		{
			...
			OnEquipmentEquipInteractionViewToggled?.Invoke(obj: false);
	...
	private void OnMainAgentChanged(Agent oldAgent)
	{
		if (((MissionBehavior)this).Mission.MainAgent == null)
		{
			...
			if (DropHoldHandled)
			{
				OnEquipmentDropInteractionViewToggled?.Invoke(obj: false);
				DropHoldHandled = false;
			}
			_dropHoldTime = 0f;
	...
	private void HandleOpeningHoldEquip()
	{
		...
		OnEquipmentEquipInteractionViewToggled?.Invoke(obj: true);
	}
	...
	private void HandleOpeningHoldDrop()
	{
		...
		OnEquipmentDropInteractionViewToggled?.Invoke(obj: true);
	}

...
public class CPUBenchmarkMissionLogic : MissionLogic
{
	...
	public override void OnBehaviorInitialize()
	{
		...
		_missionAgentSpawnLogic = ((MissionBehavior)this).Mission.GetMissionBehavior<DefaultBattleMissionAgentSpawnLogic>();
	...
	public static Mission OpenCPUBenchmarkMission(string scene)
	{
		...
		if (!_isSiege)
		{
			...
			return MissionState.OpenNew("CPUBenchmarkMission", val6, (InitializeMissionBehaviorsDelegate)delegate
			{
				//IL_002d: Unknown result type (might be due to invalid IL or missing references)
				//IL_0033: Expected O, but got Unknown
				...
				return (IEnumerable<MissionBehavior>)(object)new MissionBehavior[10]
				{
					...
					(MissionBehavior)new DefaultBattleMissionAgentSpawnLogic(troopSuppliers, (BattleSideEnum)1, (BattleSizeType)0),

...
public class RussianTextProcessor : LanguageSpecificTextProcessor
{
	...
	private struct IrregularWord(string nominative, string nominativePlural, string genitive, string genitivePlural, string dative, string dativePlural, string accusative, string accusativePlural, string instrumental, string instrumentalPlural, string locative, string locativePlural)
	{
		public readonly string Nominative = nominative;

		public readonly string NominativePlural = nominativePlural;

		public readonly string Accusative = accusative;

		public readonly string Genitive = genitive;

		public readonly string Instrumental = instrumental;

		public readonly string Locative = locative;

		public readonly string Dative = dative;

		public readonly string AccusativePlural = accusativePlural;

		public readonly string GenitivePlural = genitivePlural;

		public readonly string InstrumentalPlural = instrumentalPlural;

		public readonly string LocativePlural = locativePlural;

		public readonly string DativePlural = dativePlural;
	}

...
public class TownHorseRaceMissionController : MissionLogic, ITournamentGameBehavior
{
	...
	private void CollectCheckPointsAndStartPoints()
	{
		...
		foreach (WeakGameEntity item in ((IEnumerable<MissionObject>)((MissionBehavior)this).Mission.ActiveMissionObjects).Select(delegate(MissionObject amo)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return ((ScriptComponentBehavior)amo).GameEntity;
		}))
		{

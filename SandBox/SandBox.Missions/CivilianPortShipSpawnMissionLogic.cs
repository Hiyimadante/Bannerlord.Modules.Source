...
public class CivilianPortShipSpawnMissionLogic : MissionLogic
{
	...
	private void SpawnShip(Ship ship)
	{
		...
		GameEntity val = VisualShipFactory.CreateVisualShip(obj.Prefab, ((MissionBehavior)this).Mission.Scene, ship.GetShipVisualSlotInfos(), ship.RandomValue, ship.HitPoints / ship.MaxSailHitPoints, item, item2, true, true);

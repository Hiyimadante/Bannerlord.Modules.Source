...
public class ConversationMissionLogic : MissionLogic
{
	...
	[CompilerGenerated]
	private ConversationCharacterData _003COtherSideConversationData_003Ek__BackingField;

	[CompilerGenerated]
	private ConversationCharacterData _003CPlayerConversationData_003Ek__BackingField;
	...
	public ConversationCharacterData OtherSideConversationData
	{
		...
		get
		{
			...
			return _003COtherSideConversationData_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003COtherSideConversationData_003Ek__BackingField = value;
		}
	}
	...
	public ConversationCharacterData PlayerConversationData
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CPlayerConversationData_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CPlayerConversationData_003Ek__BackingField = value;
		}
	}
	...
	public ConversationMissionLogic(ConversationCharacterData playerCharacterData, ConversationCharacterData otherCharacterData, bool isMultiAgentConversation)
	{
		...
		if (!isMultiAgentConversation)
		{
			...
			else
			{
				...
				isNaval = ((((mobileParty2 != null) ? new bool?(mobileParty2.IsCurrentlyAtSea) : ((bool?)null)) == true) ? 1 : 0);
			}
		}
		else
		{
	...
	private void SpawnBodyguards(bool isDefenderSide)
	{
		...
		{
			foreach (TroopRosterElement item2 in ((IEnumerable<TroopRosterElement>)memberRoster.GetTroopRoster()).OrderByDescending(delegate(TroopRosterElement k)
			{
				//IL_0000: Unknown result type (might be due to invalid IL or missing references)
				return ((BasicCharacterObject)k.Character).Level;
			}))
			{
	...
	private string GetNavalConversationCameraTag(PartyBase encounteredParty)
	{
		...
		if (MobileParty.MainParty.IsCurrentlyAtSea)
		{
			...
			{
				val = (ShipType)((((List<Ship>)(object)PartyBase.MainParty.Ships).Count <= 0) ? 1 : ((int)PartyBase.MainParty.FlagShip.ShipHull.Type));
				val2 = (Extensions.IsEmpty<Ship>((IEnumerable<Ship>)encounteredParty.Ships) ? val : encounteredParty.FlagShip.ShipHull.Type);
				goto IL_0091;
			}
		}
		val = (ShipType)1;

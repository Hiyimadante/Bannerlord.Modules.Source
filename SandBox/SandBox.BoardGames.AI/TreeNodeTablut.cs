...
{
	private struct SimulationResult(BoardGameTablut.State s, int turns)
	{
		public readonly BoardGameTablut.State EndState = s;

		public readonly int TurnsNeededToReachEndState = turns;
	}

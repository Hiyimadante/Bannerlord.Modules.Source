...
public class BoardGameSeega : BoardGameBase
{
	...
	{
		public readonly PawnInformation[] PawnInformation = pawns;

		public readonly TileBaseInformation[,] TileInformation = tiles;
	}
	...
	public BoardGameSeega(MissionBoardGameLogic mission, PlayerTurn startingPlayer)
	{
		...
		_blockingPawns = new Dictionary<PawnBase, int>();
		base._002Ector(mission, new TextObject("{=C4n1rgBC}Seega", (Dictionary<string, object>)null), startingPlayer);
		SelectedUnit = null;
	}

...
public class AlleyFightMissionHandler : MissionLogic, IMissionAgentSpawnLogic, IMissionBehavior
{
	...
	public BattleSideEnum PlayerSide => (BattleSideEnum)0;
	...
	{
		((MissionBehavior)this).Mission.GetAgentTroopClass_Override += GetAlleyFightMissionTroopClass;
	}
	...
	public override void OnAgentRemoved(Agent affectedAgent, Agent affectorAgent, AgentState agentState, KillingBlow blow)
	{
		...
		if (_playerSideAliveAgents.Contains(affectedAgent))
		{
			...
			TroopRoster playerSideTroops = _playerSideTroops;
			BasicCharacterObject character = affectedAgent.Character;
			playerSideTroops.RemoveTroop((CharacterObject)(object)((character is CharacterObject) ? character : null), 1, default(UniqueTroopDescriptor), 0);
		}
		else if (_rivalSideAliveAgents.Contains(affectedAgent))
		{
			_rivalSideAliveAgents.Remove(affectedAgent);
			TroopRoster rivalSideTroops = _rivalSideTroops;
			BasicCharacterObject character2 = affectedAgent.Character;
			rivalSideTroops.RemoveTroop((CharacterObject)(object)((character2 is CharacterObject) ? character2 : null), 1, default(UniqueTroopDescriptor), 0);
		}
	...
	private void SpawnATroop(CharacterObject character, bool isPlayerSide)
	{
		...
		Agent val2 = Mission.Current.SpawnTroop((IAgentOriginBase)(object)val, isPlayerSide, true, false, false, 0, 0, true, true, (Vec3?)null, (Vec2?)null, (string)null, (ItemObject)null, (FormationClass)10, false);
		if (isPlayerSide)
		{

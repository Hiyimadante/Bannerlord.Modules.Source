...
public class PrisonBreakMissionController : MissionLogic
{
	...
	private void PreparePrisonAgent()
	{
		...
		ItemObject val = Extensions.MinBy<ItemObject, int>(((IEnumerable<ItemObject>)Items.All).Where(delegate(ItemObject x)
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Invalid comparison between Unknown and I4
			//IL_0017: Unknown result type (might be due to invalid IL or missing references)
			//IL_001d: Invalid comparison between Unknown and I4
			return x.IsCraftedWeapon && (int)x.Type == 2 && (int)x.WeaponComponent.GetItemType() == 2 && x.IsCivilian;
		}), (Func<ItemObject, int>)((ItemObject x) => x.Value));
	...
	public override void OnMissionTick(float dt)
	{
		...
		{
			Mission.Current.RemoveMissionBehavior((MissionBehavior)(object)_failCounterMissionLogic);

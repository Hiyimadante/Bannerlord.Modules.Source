...
public class CommonTownsfolkCampaignBehavior : CampaignBehaviorBase
{
	...
	private static LocationCharacter CreateTownsManCarryingStuff(CultureObject culture, CharacterRelations relation)
	{
		...
		string actionSetSuffixAndMonsterForItem = GetActionSetSuffixAndMonsterForItem(randomStuff, ((BasicCharacterObject)townsman).Race, isFemale: false, out var monster);
		int num = default(int);
		int num2 = default(int);
	...
	private static LocationCharacter CreateTownsWomanCarryingStuff(CultureObject culture, CharacterRelations relation)
	{
		...
		string actionSetSuffixAndMonsterForItem = GetActionSetSuffixAndMonsterForItem(randomStuff, ((BasicCharacterObject)townswoman).Race, isFemale: false, out var monster);
		int num = default(int);
		int num2 = default(int);

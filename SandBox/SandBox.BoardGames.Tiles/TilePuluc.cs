...
{
	[CompilerGenerated]
	private Vec3 _003CPosLeft_003Ek__BackingField;

	[CompilerGenerated]
	private Vec3 _003CPosLeftMid_003Ek__BackingField;

	[CompilerGenerated]
	private Vec3 _003CPosRight_003Ek__BackingField;

	[CompilerGenerated]
	private Vec3 _003CPosRightMid_003Ek__BackingField;
	...
	public Vec3 PosLeft
	{
		...
		get
		{
			...
			return _003CPosLeft_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CPosLeft_003Ek__BackingField = value;
		}
	}

	public Vec3 PosLeftMid
	{
		[CompilerGenerated]
		get
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CPosLeftMid_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CPosLeftMid_003Ek__BackingField = value;
		}
	}

	public Vec3 PosRight
	{
		[CompilerGenerated]
		get
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CPosRight_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CPosRight_003Ek__BackingField = value;
		}
	}

	public Vec3 PosRightMid
	{
		[CompilerGenerated]
		get
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CPosRightMid_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CPosRightMid_003Ek__BackingField = value;
		}
	}

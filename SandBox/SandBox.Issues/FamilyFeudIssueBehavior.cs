	...
	public class FamilyFeudIssue : IssueBase
	{
		...
		public override TextObject IssueAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=XX3sWsVX}This sounds pretty serious. Go on.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssuePlayerResponseAfterLordExplanation
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=A3GfCPUb}I'm not sure about using my authority in this way. Is there any other way to solve this?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssuePlayerResponseAfterAlternativeExplanation
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=8EaCJ2uw}What else can I do?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueLordSolutionResponseByIssueGiver
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=xNyLPMnx}Thank you, my {?PLAYER.GENDER}lady{?}lord{\\?}, thank you.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueLordSolutionCounterOfferBriefByOtherNpc
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=JhbbB2dp}My {?PLAYER.GENDER}lady{?}lord{\\?}, may I have a word please?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueLordSolutionCounterOfferAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=TIVHLAjy}You may have a point. I hereby revoke my previous decision.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueLordSolutionCounterOfferAcceptResponseByOtherNpc
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=A9uSikTY}Thank you my {?PLAYER.GENDER}lady{?}lord{\\?}.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueLordSolutionCounterOfferDeclineByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=Vs9DfZmJ}No. My word is final. You will have to take the blood money.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueLordSolutionCounterOfferDeclineResponseByOtherNpc
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=3oaVUNdr}I hope you won't be [if:convo_disbelief]regret with your decision, my {?PLAYER.GENDER}lady{?}lord{\\?}.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueQuestSolutionAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=VcfZdKcp}Don't worry, I will protect your relative.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject Title
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=ZpDQxmzJ}Family Feud", (Dictionary<string, object>)null);
			}
		}
		...
		{
			((IssueBase)this).CounterOfferHero = ((IEnumerable<Hero>)((IssueBase)this).IssueOwner.CurrentSettlement.Notables).FirstOrDefault((Hero x) => ((BasicCharacterObject)x.CharacterObject).IsHero && x.CharacterObject.HeroObject != ((IssueBase)this).IssueOwner);
		}
	...
	public class FamilyFeudIssueQuest : QuestBase
	{
		...
		private TextObject CompanionLimitReachedQuestLogText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=rkQ7D36f}The quest was canceled because your party had more companions than you could manage.", (Dictionary<string, object>)null);
			}
		}
		...
		public FamilyFeudIssueQuest(string questId, Hero questGiver, CampaignTime duration, Settlement targetSettlement, Hero targetHero, int rewardGold)
		{
			...
			((QuestBase)this)._002Ector(questId, questGiver, duration, rewardGold);
		...
		{
			if (mapEvent.IsPlayerMapEvent && _culpritJoinedPlayerParty && !((List<TroopRosterElement>)(object)MobileParty.MainParty.MemberRoster.GetTroopRoster()).Exists((Predicate<TroopRosterElement>)delegate(TroopRosterElement x)
			{
				//IL_0000: Unknown result type (might be due to invalid IL or missing references)
				return x.Character == _culprit.CharacterObject;
			}))
			{
				((QuestBase)this).AddLog(FailQuestLogText, false);
				TiemoutFailConsequences();

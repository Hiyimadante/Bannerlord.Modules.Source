...
public class RuralNotableInnAndOutIssueBehavior : CampaignBehaviorBase
{
	...
	public class RuralNotableInnAndOutIssue : IssueBase
	{
		...
		public override TextObject Title
		{
			get
			{
				...
				return new TextObject("{=uUhtKnfA}Inn and Out", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=h2tMadtI}I've heard that story before. What did you lose?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueQuestSolutionAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=KMThnMbt}I'll go to the tavern and win it back the same way you lost it.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueDiscussAlternativeSolution
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=1yEyUHJe}I really hope your men can get my deed back. [if:convo_excited]On my father's name, I will never gamble again.", (Dictionary<string, object>)null);
			}
		}
	...
	public class RuralNotableInnAndOutIssueQuest : QuestBase
	{
		...
		public RuralNotableInnAndOutIssueQuest(string questId, Hero giverHero, CampaignTime duration, int rewardGold)
		{
			...
			((QuestBase)this)._002Ector(questId, giverHero, duration, rewardGold);
			InitializeQuestVariables();

...
public class ProdigalSonIssueBehavior : CampaignBehaviorBase
{
	...
	public class ProdigalSonIssue : IssueBase
	{
		...
		public override TextObject IssueAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=YtS3cgto}What are you planning to do?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssuePlayerResponseAfterAlternativeExplanation
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=4zf1lg6L}I could go myself, or send a companion.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueQuestSolutionAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=aKbyJsho}I will free your kinsman myself.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueDiscussAlternativeSolution
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=qxhMagyZ}I'm glad someone's on it.[if:convo_relaxed_happy] Just see that they do it quickly.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueAlternativeSolutionResponseByIssueGiver
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=mDXzDXKY}Very good. [if:convo_relaxed_happy]I'm sure you'll chose competent men to bring our boy back.", (Dictionary<string, object>)null);
			}
		}
		...
		public ProdigalSonIssue(Hero issueOwner, Hero prodigalSon, Hero targetGangHero)
		{
			...
			((IssueBase)this)._002Ector(issueOwner, CampaignTime.DaysFromNow(50f));
		...
		{
			Town val = ((IEnumerable<Town>)Town.AllTowns).FirstOrDefault((Town x) => ((SettlementComponent)x).Settlement.LocationComplex.GetListOfLocations().Contains(_targetHouse));
			if (val != null)
			{
	...
	{
		if (settlement.IsTown && settlement.MapFaction == issueGiver.MapFaction && settlement != issueGiver.CurrentSettlement && settlement.OwnerClan != issueGiver.Clan && settlement.OwnerClan != Clan.PlayerClan && ((IEnumerable<Hero>)settlement.HeroesWithoutParty).FirstOrDefault((Hero x) => x.CanHaveCampaignIssues() && x.IsGangLeader) != null)
		{
	...
	private bool ConditionsHold(Hero issueGiver, out Hero selectedHero, out Hero targetHero)
	{
		...
		if (issueGiver.IsLord && !issueGiver.IsPrisoner && issueGiver.Clan != Clan.PlayerClan && issueGiver.Age > 30f && issueGiver.GetTraitLevel(DefaultTraits.Mercy) <= 0 && (issueGiver.CurrentSettlement != null || issueGiver.PartyBelongedTo != null))
		{
			...
			{
				Settlement val = SettlementHelper.FindRandomSettlement((Func<Settlement, bool>)((Settlement x) => ConditionsHoldForSettlement(x, issueGiver) && ((IEnumerable<Hero>)x.HeroesWithoutParty).FirstOrDefault((Hero y) => y.CanHaveCampaignIssues() && y.IsGangLeader && Campaign.Current.Models.MapDistanceModel.GetDistance(issueGiver.CurrentSettlement, x, false, false, (NavigationType)1) < MaxDistanceForSettlementSelection) != null));
				targetHero = ((val != null) ? ((IEnumerable<Hero>)val.HeroesWithoutParty).FirstOrDefault((Hero y) => y.CanHaveCampaignIssues() && y.IsGangLeader) : null);
			}
		}
		if (selectedHero != null)
		{

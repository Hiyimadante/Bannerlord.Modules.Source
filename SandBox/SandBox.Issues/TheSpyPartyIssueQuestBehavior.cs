...
public class TheSpyPartyIssueQuestBehavior : CampaignBehaviorBase
{
	...
	{
		[SaveableField(10)]
		public readonly CharacterObject CharacterObject = characterObject;

		[SaveableField(20)]
		public readonly bool HasHair = hasHair;

		[SaveableField(30)]
		public readonly bool HasBigSword = hasBigSword;

		[SaveableField(40)]
		public readonly bool WithoutMarkings = withoutMarkings;

		[SaveableField(50)]
		public readonly bool HasBeard = hasBeard;
	...
	public class TheSpyPartyIssue : IssueBase
	{
		...
		public override TextObject IssueAcceptByPlayer
		{
			get
			{
				...
				return new TextObject("{=EYT7b2J5}Any traveler can be asked by an enemy to spy on the places he travels. How can I track this one down?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssuePlayerResponseAfterAlternativeExplanation
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=2nFBTmao}Is there any other way to solve this other than asking around?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueQuestSolutionAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=99OsuHGa}I will find the one you are looking for.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject Title
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=SJHtVaNa}The Spy Among Us", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueDiscussAlternativeSolution
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=O0Cjam62}I hope your people are careful about how they proceed.[if:convo_focused_happy] It would be a pity if that spy got away.", (Dictionary<string, object>)null);
			}
		}
		...
		public TheSpyPartyIssue(Hero issueOwner, Settlement selectedSettlement)
		{
			...
			((IssueBase)this)._002Ector(issueOwner, CampaignTime.DaysFromNow(5f));

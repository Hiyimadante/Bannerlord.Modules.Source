	...
	public class RivalGangMovingInIssue : IssueBase
	{
		...
		public override TextObject IssueAlternativeSolutionSuccessLog
		{
			get
			{
				...
				TextObject val = new TextObject("{=pzvQ1DkE}Your companion has defeated the rival gang and protected the interests of {QUEST_GIVER.LINK} in {SETTLEMENT}.", (Dictionary<string, object>)null);
				TextObjectExtensions.SetCharacterProperties(val, "QUEST_GIVER", ((IssueBase)this).IssueOwner.CharacterObject, false);
				val.SetTextVariable("SETTLEMENT", ((IssueBase)this).IssueOwner.CurrentSettlement.Name);
				return val;
			}
		}
		...
		public override TextObject IssueAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=kc6vCycY}What exactly do you want me to do?", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueQuestSolutionAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=LdCte9H0}I'll fight the other gang with you myself.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueAlternativeSolutionAcceptByPlayer
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=AdbiUqtT}I'm busy, but I will leave a companion and some men.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueAlternativeSolutionResponseByIssueGiver
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=0enbhess}Thank you. [ib:normal][if:convo_approving]I'm sure your guys are worth their salt..", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject IssueDiscussAlternativeSolution
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=QR0V8Ae5}Our lads are well hidden nearby,[ib:normal][if:convo_excited] waiting for the signal to go get those bastards. I won't forget this little favor you're doing me.", (Dictionary<string, object>)null);
			}
		}
		...
		public override TextObject Description
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				return new TextObject("{=H4EVfKAh}Gang leader needs help to beat the rival gang.", (Dictionary<string, object>)null);
			}
		}
		...
		public RivalGangMovingInIssue(Hero issueOwner, Hero rivalGangLeader)
		{
			...
			((IssueBase)this)._002Ector(issueOwner, CampaignTime.DaysFromNow(15f));
	...
	public class RivalGangMovingInIssueQuest : QuestBase
	{
		...
		private TextObject OnQuestFailedWithRejectionLogText
		{
			get
			{
				//IL_0006: Unknown result type (might be due to invalid IL or missing references)
				//IL_000c: Expected O, but got Unknown
				TextObject val = new TextObject("{=aXMg9M7t}You didn't respond to the messenger {QUEST_GIVER.LINK} sent you. {?QUEST_GIVER.GENDER}She{?}He{\\?} will certainly lose to the rival gang without your help.", (Dictionary<string, object>)null);
				StringHelpers.SetCharacterProperties("QUEST_GIVER", ((QuestBase)this).QuestGiver.CharacterObject, val, false);
				return val;
			}
		}
		...
		public RivalGangMovingInIssueQuest(string questId, Hero questGiver, Hero rivalGangLeader, int duration, int rewardGold, float issueDifficulty)
		{
			...
			((QuestBase)this)._002Ector(questId, questGiver, CampaignTime.DaysFromNow((float)duration), rewardGold);
		...
		private CharacterObject GetTroopTypeTemplateForDifficulty()
		{
			...
			CharacterObject val = ((difficultyRange == 1) ? ((IEnumerable<CharacterObject>)CharacterObject.All).FirstOrDefault((CharacterObject t) => ((MBObjectBase)t).StringId == "looter") : ((difficultyRange != 10) ? ((IEnumerable<CharacterObject>)CharacterObject.All).FirstOrDefault((CharacterObject t) => ((MBObjectBase)t).StringId == "mercenary_" + (difficultyRange - 1)) : ((IEnumerable<CharacterObject>)CharacterObject.All).FirstOrDefault((CharacterObject t) => ((MBObjectBase)t).StringId == "mercenary_8")));
			if (val == null)
			{
		...
		private void PreparePlayerParty()
		{
			...
			PartyBase.MainParty.MemberRoster.RemoveIf((Predicate<TroopRosterElement>)delegate(TroopRosterElement t)
			{
				//IL_0000: Unknown result type (might be due to invalid IL or missing references)
				return !((BasicCharacterObject)t.Character).IsPlayerCharacter;
			});
			...
			_sentTroops.Clear();
			int num = 5;
			foreach (TroopRosterElement item2 in _allPlayerTroops.OrderByDescending(delegate(TroopRosterElement t)
			{
				//IL_0000: Unknown result type (might be due to invalid IL or missing references)
				return ((BasicCharacterObject)t.Character).Level;
			}))
		...
		protected override void OnFinalize()
		{
			...
			{
				_allyGangLeaderHenchmanHero.SetNewOccupation((Occupation)31);

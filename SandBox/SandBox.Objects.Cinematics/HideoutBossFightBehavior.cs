...
public class HideoutBossFightBehavior : ScriptComponentBehavior
{
	...
	public HideoutBossFightBehavior()
	{
		...
		OuterRadius = 6f;
		WalkDistance = 3f;
		_perturbRng = new Random(0);
		_previousEntityFrame = MatrixFrame.Identity;
		_previewAllies = new List<HideoutBossFightPreviewEntityInfo>();
		_previewBandits = new List<HideoutBossFightPreviewEntityInfo>();
		_previewBoss = HideoutBossFightPreviewEntityInfo.Invalid;
		_previewPlayer = HideoutBossFightPreviewEntityInfo.Invalid;

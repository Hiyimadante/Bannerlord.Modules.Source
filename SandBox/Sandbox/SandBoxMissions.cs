...
public static class SandBoxMissions
{
	...
	private sealed class _003C_003Ec
	{
		...
		public static Predicate<FlattenedTroopRosterElement> _003C_003E9__24_0;

		public static InitializeMissionBehaviorsDelegate _003C_003E9__25_0;

		public static InitializeMissionBehaviorsDelegate _003C_003E9__30_0;

		public static InitializeMissionBehaviorsDelegate _003C_003E9__34_0;
		...
		internal bool _003COpenHideoutAmbushMission_003Eb__24_0(FlattenedTroopRosterElement x)
		{
			return ((BasicCharacterObject)((FlattenedTroopRosterElement)(ref x)).Troop).IsPlayerCharacter;
		}
		...
		internal IEnumerable<MissionBehavior> _003COpenMeetingMission_003Eb__30_0(Mission mission)
		{
		...
		internal IEnumerable<MissionBehavior> _003COpenSimpleMountedPlayerMission_003Eb__34_0(Mission missionController)
		{
			...
			//IL_0018: Unknown result type (might be due to invalid IL or missing references)
			//IL_001e: Expected O, but got Unknown
			return (IEnumerable<MissionBehavior>)(object)new MissionBehavior[3]
			{
				(MissionBehavior)new MissionOptionsComponent(),
				(MissionBehavior)new SimpleMountedPlayerMissionController(),
				(MissionBehavior)new EquipmentControllerLeaveLogic()
			};
		}
	}
	...
	public static MissionInitializerRecord CreateSandBoxMissionInitializerRecord(string sceneName, string sceneLevels, bool doNotUseLoadingScreen, DecalAtlasGroup decalAtlasGroup)
	{
		...
		result.AtmosphereOnCampaign = (((int)Campaign.Current.GameMode == 1) ? Campaign.Current.Models.MapWeatherModel.GetAtmosphereModel(position) : AtmosphereInfo.GetInvalidAtmosphereInfo());
	...
	public static Mission OpenIndoorMission(string scene, Location location, CharacterObject talkToChar = null, string sceneLevels = "")
	{
		...
		return MissionState.OpenNew("Indoor", CreateSandBoxMissionInitializerRecord(scene, sceneLevels, doNotUseLoadingScreen: true, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			//IL_0021: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenVillageMission(string scene, Location location, CharacterObject talkToChar = null, string sceneLevels = null)
	{
		...
		return MissionState.OpenNew("Village", CreateSandBoxMissionInitializerRecord(scene, sceneLevels2, doNotUseLoadingScreen: false, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			//IL_0031: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenArenaStartMission(string scene, Location location, CharacterObject talkToChar = null, string sceneLevels = "")
	{
		...
		//IL_0029: Unknown result type (might be due to invalid IL or missing references)
		//IL_0035: Expected O, but got Unknown
		return MissionState.OpenNew("ArenaPracticeFight", CreateSandBoxMissionInitializerRecord(scene, sceneLevels, doNotUseLoadingScreen: false, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			...
			return (IEnumerable<MissionBehavior>)(object)new MissionBehavior[14]
			{
				(MissionBehavior)new MissionOptionsComponent(),
				(MissionBehavior)new EquipmentControllerLeaveLogic(),
	...
	public static Mission OpenRetirementMission(string scene, Location location, CharacterObject talkToChar = null, string sceneLevels = null, string unconsciousMenuId = "")
	{
		...
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		//IL_003d: Expected O, but got Unknown
		return MissionState.OpenNew("Retirement", CreateSandBoxMissionInitializerRecord(scene, sceneLevels, doNotUseLoadingScreen: false, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			//IL_0031: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenArenaDuelMission(string scene, Location location, CharacterObject duelCharacter, bool requireCivilianEquipment, bool spawnBOthSidesWithHorse, Action<CharacterObject> onDuelEnd, float customAgentHealth, string sceneLevels = "")
	{
		...
		//IL_0055: Expected O, but got Unknown
		return MissionState.OpenNew("ArenaDuelMission", CreateSandBoxMissionInitializerRecord(scene, sceneLevels, doNotUseLoadingScreen: false, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			//IL_0037: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenArenaDuelMission(string scene, Location location)
	{
		...
		return MissionState.OpenNew("ArenaDuel", CreateSandBoxMissionInitializerRecord(scene, "", doNotUseLoadingScreen: false, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			//IL_0021: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenCaravanBattleMission(MissionInitializerRecord rec, bool isCaravan)
	{
		...
		return MissionState.OpenNew("Battle", rec, (InitializeMissionBehaviorsDelegate)delegate
		{
			...
			obj[27] = (MissionBehavior)new CaravanBattleMissionHandler(MathF.Min(MapEvent.PlayerMapEvent.InvolvedParties.Where(delegate(PartyBase ip)
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				//IL_0007: Invalid comparison between Unknown and I4
				return (int)ip.Side == 1;
			}).Sum((PartyBase ip) => ip.MobileParty.Party.MemberRoster.TotalManCount - ip.MobileParty.Party.MemberRoster.TotalWounded), MapEvent.PlayerMapEvent.InvolvedParties.Where(delegate(PartyBase ip)
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				//IL_0007: Invalid comparison between Unknown and I4
				return (int)ip.Side == 0;
			}).Sum((PartyBase ip) => ip.MobileParty.Party.MemberRoster.TotalManCount - ip.MobileParty.Party.MemberRoster.TotalWounded)), MapEvent.PlayerMapEvent.InvolvedParties.Any((PartyBase ip) => (ip.MobileParty.IsCaravan || ip.MobileParty.IsVillager) && (((MBObjectBase)ip.Culture).StringId == "aserai" || ((MBObjectBase)ip.Culture).StringId == "khuzait")), isCaravan);
	...
	{
		//IL_000a: Unknown result type (might be due to invalid IL or missing references)
		return OpenBattleMission(CreateSandBoxMissionInitializerRecord(scene, sceneLevels, doNotUseLoadingScreen: false, (DecalAtlasGroup)(usesTownDecalAtlas ? 3 : 2)));
	}
	...
	public static Mission OpenHideoutAmbushMission(string sceneName, FlattenedTroopRoster playerTroops, Location location)
	{
		...
		priorAllyTroops.RemoveIf((Predicate<FlattenedTroopRosterElement>)((FlattenedTroopRosterElement x) => ((BasicCharacterObject)((FlattenedTroopRosterElement)(ref x)).Troop).IsPlayerCharacter));
		MissionInitializerRecord val = default(MissionInitializerRecord);
		...
		int playerTroopCount = ((IEnumerable<FlattenedTroopRosterElement>)priorAllyTroops).Count();
		return MissionState.OpenNew("HideoutAmbushMission", val2, (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0016: Unknown result type (might be due to invalid IL or missing references)
			//IL_001c: Expected O, but got Unknown
			//IL_002b: Unknown result type (might be due to invalid IL or missing references)
			...
			{
				(IMissionTroopSupplier)new PartyGroupTroopSupplier(MapEvent.PlayerMapEvent, (BattleSideEnum)0, banditPriorityList, (Func<UniqueTroopDescriptor, MapEventParty, bool>)null),
				(IMissionTroopSupplier)new PartyGroupTroopSupplier(MapEvent.PlayerMapEvent, (BattleSideEnum)1, priorAllyTroops, (Func<UniqueTroopDescriptor, MapEventParty, bool>)null)
			};
			return (IEnumerable<MissionBehavior>)(object)new MissionBehavior[31]
			{
				...
				(MissionBehavior)new HideoutAmbushMissionController(suppliers, (BattleSideEnum)1, playerTroopCount),
				(MissionBehavior)new BattleEndLogic(),
				(MissionBehavior)new MountAgentLogic(),
	...
	public static Mission OpenCampMission(string scene)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val2 = delegate
			{
				//IL_0009: Unknown result type (might be due to invalid IL or missing references)
				//IL_000f: Expected O, but got Unknown
				//IL_0019: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenConversationMission(ConversationCharacterData playerCharacterData, ConversationCharacterData conversationPartnerData, string specialScene = "", string sceneLevels = "", bool isMultiAgentConversation = false)
	{
		...
		CampaignVec2 val = ((party != null) ? party.Position : PartyBase.MainParty.Position);
		string sceneName = (Extensions.IsEmpty<char>((IEnumerable<char>)specialScene) ? Campaign.Current.Models.SceneModel.GetConversationSceneForMapPosition(val) : specialScene);
		return MissionState.OpenNew("Conversation", CreateSandBoxMissionInitializerRecord(sceneName, sceneLevels, doNotUseLoadingScreen: true, (DecalAtlasGroup)3), (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0018: Unknown result type (might be due to invalid IL or missing references)
			//IL_001e: Expected O, but got Unknown
			//IL_0021: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenMeetingMission(string scene, CharacterObject character)
	{
		...
		if (obj == null)
		{
			...
			_003C_003Ec._003C_003E9__30_0 = val2;
			obj = (object)val2;
		}
	...
	private static DefaultBattleMissionAgentSpawnLogic CreateCampaignMissionAgentSpawnLogic(BattleSizeType battleSizeType, FlattenedTroopRoster priorTroopsForDefenders = null, FlattenedTroopRoster priorTroopsForAttackers = null)
	{
		//IL_0010: Unknown result type (might be due to invalid IL or missing references)
		//IL_0016: Expected O, but got Unknown
		//IL_0020: Unknown result type (might be due to invalid IL or missing references)
		...
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		//IL_0037: Expected O, but got Unknown
		return new DefaultBattleMissionAgentSpawnLogic((IMissionTroopSupplier[])(object)new IMissionTroopSupplier[2]
		{
	...
	public static Mission OpenDisguiseMission(string scene, bool willSetUpContact, Location fromLocation, string sceneLevels = null)
	{
		...
		MissionInitializerRecord val = CreateSandBoxMissionInitializerRecord(scene, sceneLevels, doNotUseLoadingScreen: false, (DecalAtlasGroup)3);
		return MissionState.OpenNew("DisguiseMission", val, (InitializeMissionBehaviorsDelegate)delegate
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Expected O, but got Unknown
			//IL_0029: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Mission OpenSimpleMountedPlayerMission(string scene, string sceneLevels)
	{
		...
		if (obj == null)
		{
			InitializeMissionBehaviorsDelegate val3 = delegate
			{
				//IL_0008: Unknown result type (might be due to invalid IL or missing references)
				//IL_000e: Expected O, but got Unknown
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
			...
			_003C_003Ec._003C_003E9__34_0 = val3;
			obj = (object)val3;
		}
		return MissionState.OpenNew("SimpleMountedPlayer", val2, (InitializeMissionBehaviorsDelegate)obj, true, true);
	}
}

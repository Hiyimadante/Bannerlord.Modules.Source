...
public class CampaignMissionManager : ICampaignMissionManager
{
	...
	IMission ICampaignMissionManager.OpenBattleMission(string scene, bool usesTownDecalAtlas, string sceneLevels)
	{
		return (IMission)(object)SandBoxMissions.OpenBattleMission(scene, usesTownDecalAtlas, sceneLevels);
	}
	...
	{
		return (IMission)(object)SandBoxMissions.OpenHideoutBattleMission(scene, playerTroops, isTutorial);
	}

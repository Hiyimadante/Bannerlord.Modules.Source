...
public class SandboxBattleBannerBearersModel : BattleBannerBearersModel
{
	...
	public override bool CanFormationDeployBannerBearers(Formation formation)
	{
		...
		return ((IEnumerable<IFormationUnit>)formation.UnitsWithoutLooseDetachedOnes).Count((IFormationUnit unit) =>
		{
			Agent val;
			return (val = (Agent)(object)((unit is Agent) ? unit : null)) != null && ((BattleBannerBearersModel)this).CanAgentBecomeBannerBearer(val);
		}) > 0;
	}
	...
	public override ItemObject GetBannerBearerReplacementWeapon(BasicCharacterObject agentCharacter)
	{
		...
		CharacterObject val;
		if ((val = (CharacterObject)(object)((agentCharacter is CharacterObject) ? agentCharacter : null)) != null)
		{
			BasicCultureObject culture = agentCharacter.Culture;
			CultureObject val2;
			if ((val2 = (CultureObject)(object)((culture is CultureObject) ? culture : null)) != null && !Extensions.IsEmpty<ItemObject>((IEnumerable<ItemObject>)val2.BannerBearerReplacementWeapons))
			{

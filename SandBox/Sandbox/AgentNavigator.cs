...
public sealed class AgentNavigator
{
	...
	[CompilerGenerated]
	private WorldPosition _003CTargetPosition_003Ek__BackingField;

	[CompilerGenerated]
	private Vec2 _003CTargetDirection_003Ek__BackingField;
	...
	public Vec2 TargetDirection
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CTargetDirection_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CTargetDirection_003Ek__BackingField = value;
		}
	}

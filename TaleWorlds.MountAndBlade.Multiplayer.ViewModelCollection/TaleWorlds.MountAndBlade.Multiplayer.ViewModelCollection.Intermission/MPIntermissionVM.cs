...
public class MPIntermissionVM : ViewModel
{
	...
	public MPIntermissionVM()
	{
		...
		_voteLabelText = new TextObject("{=KOVHgkVq}Voting Ends In:", (Dictionary<string, object>)null);
		_nextGameLabelText = new TextObject("{=lX9Qx7Wo}Next Game Starts In:", (Dictionary<string, object>)null);
		_serverIdleLabelText = new TextObject("{=Rhcberxf}Awaiting Server", (Dictionary<string, object>)null);
		_matchFinishedText = new TextObject("{=RbazQjFt}Match is Finished", (Dictionary<string, object>)null);
		_returningToLobbyText = new TextObject("{=1UaxKbn6}Returning to the Lobby...", (Dictionary<string, object>)null);

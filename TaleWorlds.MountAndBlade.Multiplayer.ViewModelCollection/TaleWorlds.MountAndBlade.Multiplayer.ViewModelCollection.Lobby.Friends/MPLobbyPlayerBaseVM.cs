...
public class MPLobbyPlayerBaseVM : ViewModel
{
	...
	[CompilerGenerated]
	private AnotherPlayerState _003CState_003Ek__BackingField;
	...
	public MPLobbyPlayerBaseVM(PlayerId id, string forcedName = "", Action<PlayerId> onInviteToClan = null, Action<PlayerId> onFriendRequestAnswered = null)
	{
		...
		_forcedName = string.Empty;
		_forcedAvatarIndex = -1;
		_genericPlayerName = new TextObject("{=RN6zHak0}Player", (Dictionary<string, object>)null);
		_name = "";
	...
	public void UpdateDisplayedRankInfo(string gameType)
	{
		...
		{
			val = RankInfo?.FirstOrDefault((GameTypeRankInfo r) => r.GameType == "Skirmish");
			RankInfoGameTypeID = "Skirmish";
		}
		else if (gameType == "Captain")
		{
			val = RankInfo?.FirstOrDefault((GameTypeRankInfo r) => r.GameType == "Captain");

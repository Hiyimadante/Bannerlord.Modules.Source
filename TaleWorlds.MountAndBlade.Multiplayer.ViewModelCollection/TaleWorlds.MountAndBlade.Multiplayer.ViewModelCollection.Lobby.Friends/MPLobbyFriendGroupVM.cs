...
{
	private readonly struct FriendOperation(FriendOperation.OperationTypes type, MPLobbyFriendItemVM friend)
	{
		...
		public readonly MPLobbyFriendItemVM Friend = friend;

		public readonly OperationTypes Type = type;
	}

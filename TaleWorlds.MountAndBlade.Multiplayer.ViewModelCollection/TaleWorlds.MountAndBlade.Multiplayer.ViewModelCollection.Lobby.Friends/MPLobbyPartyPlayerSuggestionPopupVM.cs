...
public class MPLobbyPartyPlayerSuggestionPopupVM : ViewModel
{
	...
	{
		[CompilerGenerated]
		private PlayerId _003CPlayerId_003Ek__BackingField;

		[CompilerGenerated]
		private PlayerId _003CSuggestingPlayerId_003Ek__BackingField;
		...
		public PlayerId SuggestingPlayerId
		{
			...
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				return _003CSuggestingPlayerId_003Ek__BackingField;
			}
			[CompilerGenerated]
			private set
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				//IL_0002: Unknown result type (might be due to invalid IL or missing references)
				_003CSuggestingPlayerId_003Ek__BackingField = value;
			}
		}

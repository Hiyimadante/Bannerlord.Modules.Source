...
public class MPLobbyFriendServiceVM : ViewModel
{
	...
	private void TickFriendOperations(float dt)
	{
		...
		if (receivedRequests != null)
		{
			...
			{
				if (((IEnumerable<MPLobbyFriendItemVM>)FriendRequests.FriendList).FirstOrDefault(delegate(MPLobbyFriendItemVM p)
				{
					//IL_0001: Unknown result type (might be due to invalid IL or missing references)
					//IL_0007: Unknown result type (might be due to invalid IL or missing references)
					return p.ProvidedID == friendId;
				}) == null)
				{
			...
			{
				PlayerId val = receivedRequests.FirstOrDefault(delegate(PlayerId p)
				{
					//IL_0000: Unknown result type (might be due to invalid IL or missing references)
					//IL_001c: Unknown result type (might be due to invalid IL or missing references)
					return p == ((Collection<MPLobbyFriendItemVM>)(object)FriendRequests.FriendList)[i].ProvidedID;
				});
		...
		if (pendingRequests != null)
		{
			...
			{
				if (((IEnumerable<MPLobbyFriendItemVM>)PendingRequests.FriendList).FirstOrDefault(delegate(MPLobbyFriendItemVM p)
				{
					//IL_0001: Unknown result type (might be due to invalid IL or missing references)
					//IL_0007: Unknown result type (might be due to invalid IL or missing references)
					return p.ProvidedID == friendId2;
				}) == null)
				{
			...
			{
				PlayerId val2 = pendingRequests.FirstOrDefault(delegate(PlayerId p)
				{
					//IL_0000: Unknown result type (might be due to invalid IL or missing references)
					//IL_001c: Unknown result type (might be due to invalid IL or missing references)
					return p == ((Collection<MPLobbyFriendItemVM>)(object)PendingRequests.FriendList)[i2].ProvidedID;
				});
	...
	private void UpdateFriendStates(float dt)
	{
		...
		if (_lastStateRequestTimePassed >= 10f)
		{
			...
			list.AddRange(((IEnumerable<MPLobbyFriendItemVM>)InGameFriends.FriendList).Select(delegate(MPLobbyFriendItemVM p)
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				return p.ProvidedID;
			}));
			list.AddRange(((IEnumerable<MPLobbyFriendItemVM>)OnlineFriends.FriendList).Select(delegate(MPLobbyFriendItemVM p)
			{
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				return p.ProvidedID;
			}));
	...
	private void RemoveFriend(PlayerId providedId)
	{
		...
		MPLobbyFriendItemVM mPLobbyFriendItemVM = ((IEnumerable<MPLobbyFriendItemVM>)InGameFriends.FriendList).ToList().FirstOrDefault(delegate(MPLobbyFriendItemVM p)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			return p.ProvidedID == providedId;
		});
		...
		mPLobbyFriendItemVM = ((IEnumerable<MPLobbyFriendItemVM>)OnlineFriends.FriendList).ToList().FirstOrDefault(delegate(MPLobbyFriendItemVM p)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			return p.ProvidedID == providedId;
		...
		mPLobbyFriendItemVM = ((IEnumerable<MPLobbyFriendItemVM>)OfflineFriends.FriendList).ToList().FirstOrDefault(delegate(MPLobbyFriendItemVM p)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			return p.ProvidedID == providedId;
	...
	private MPLobbyPlayerBaseVM GetFriendWithID(PlayerId playerId)
	{
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_0008: Unknown result type (might be due to invalid IL or missing references)
		MPLobbyFriendItemVM mPLobbyFriendItemVM = ((IEnumerable<MPLobbyFriendItemVM>)_onlineFriends.FriendList).ToList().FirstOrDefault(delegate(MPLobbyFriendItemVM p)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			return p.ProvidedID == playerId;
		});
		if (mPLobbyFriendItemVM != null)
		{
			return mPLobbyFriendItemVM;
		}
		MPLobbyFriendItemVM mPLobbyFriendItemVM2 = ((IEnumerable<MPLobbyFriendItemVM>)_inGameFriends.FriendList).ToList().FirstOrDefault(delegate(MPLobbyFriendItemVM p)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			return p.ProvidedID == playerId;
		...
		MPLobbyFriendItemVM mPLobbyFriendItemVM3 = ((IEnumerable<MPLobbyFriendItemVM>)_offlineFriends.FriendList).ToList().FirstOrDefault(delegate(MPLobbyFriendItemVM p)
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0007: Unknown result type (might be due to invalid IL or missing references)
			return p.ProvidedID == playerId;
	...
	private void ExecuteInviteToParty(PlayerId providedId)
	{
		...
		PermissionResult val3 = default(PermissionResult);
		PlatformServices.Instance.CheckPrivilege((Privilege)3, true, (PrivilegeResult)delegate(bool result)
		{
			...
			if (result)
			{
				...
				else
				{
					...
					val = ((PlayerId)(ref playerID)).ProvidedType;
				}
				if ((PlayerIdProvidedTypes?)providedType != val)
				{
				...
				{
					IPlatformServices instance = PlatformServices.Instance;
					PlayerId val2 = providedId;
					PermissionResult obj = val3;
					if (obj == null)
					{
						PermissionResult val4 = delegate(bool permissionResult)
						{
							//IL_0020: Unknown result type (might be due to invalid IL or missing references)
						...
						PermissionResult val5 = val4;
						val3 = val4;
						obj = val5;
					}
					instance.CheckPermissionWithUser((Permission)0, val2, obj);
				}
			}
		});
	}

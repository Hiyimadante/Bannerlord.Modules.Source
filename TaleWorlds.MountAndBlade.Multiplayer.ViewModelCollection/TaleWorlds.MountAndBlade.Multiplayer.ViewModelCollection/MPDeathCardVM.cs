...
public class MPDeathCardVM : ViewModel
{
	...
	public MPDeathCardVM(MultiplayerGameType gameType)
	{
		...
		_killedByStrayHorse = GameTexts.FindText("str_killed_by_stray_horse", (string)null);
		_killedSelfText = GameTexts.FindText("str_killed_self", (string)null);
		_killedByText = GameTexts.FindText("str_killed_by", (string)null);
		_enemyText = GameTexts.FindText("str_death_card_enemy", (string)null);
		_allyText = GameTexts.FindText("str_death_card_ally", (string)null);

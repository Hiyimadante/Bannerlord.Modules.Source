...
public class MPAuthenticationVM : ViewModel
{
	...
	public MPAuthenticationVM(LobbyState lobbyState)
	{
		...
		_idleTitle = new TextObject("{=g1lgiwn1}Not Logged In", (Dictionary<string, object>)null);
		_idleMessage = new TextObject("{=saZ1OvPt}You can press the login button to establish connection", (Dictionary<string, object>)null);
		_noAccessMessage = new TextObject("{=9P0VL49j}You don't have access to multiplayer.", (Dictionary<string, object>)null);
		_loggingInTitle = new TextObject("{=iNqucBor}Logging In", (Dictionary<string, object>)null);
		_loggingInMessage = new TextObject("{=U4dzbzNb}Please wait while you are being connected to the server", (Dictionary<string, object>)null);
	...
	static MPAuthenticationVM()
	{
		...
		CantLogoutLoggingInTextObject = new TextObject("{=E0q43haK}Please wait until you are logged in.", (Dictionary<string, object>)null);
		CantLogoutSearchingForMatchTextObject = new TextObject("{=DyeaObj5}Please cancel game search request before logging out.", (Dictionary<string, object>)null);
	}
}

...
public class MultiplayerEndOfRoundVM : ViewModel
{
	...
	public void Refresh()
	{
		...
		MissionScoreboardSide val3 = _scoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Invalid comparison between Unknown and I4
			return s != null && (int)s.Side == 1;
		});
		MissionScoreboardSide val4 = _scoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			//IL_000c: Invalid comparison between Unknown and I4
		...
		if (_scoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0004: Unknown result type (might be due to invalid IL or missing references)
			//IL_000a: Unknown result type (might be due to invalid IL or missing references)
			return s != null && s.Side == allyBattleSideEnum;
		}) != null && _multiplayerRoundComponent != null)
		{
			bool flag = false;

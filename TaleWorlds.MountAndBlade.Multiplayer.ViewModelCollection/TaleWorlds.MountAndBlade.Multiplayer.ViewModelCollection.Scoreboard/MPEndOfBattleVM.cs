...
public class MPEndOfBattleVM : ViewModel
{
	...
	private void InitSides()
	{
		...
		MissionScoreboardSide val2 = _missionScoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0004: Unknown result type (might be due to invalid IL or missing references)
			//IL_000a: Unknown result type (might be due to invalid IL or missing references)
			return s != null && s.Side == _allyBattleSide;
		});
		MissionScoreboardSide val3 = _missionScoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0004: Unknown result type (might be due to invalid IL or missing references)
			//IL_000a: Unknown result type (might be due to invalid IL or missing references)
			return s != null && s.Side == _enemyBattleSide;
		});

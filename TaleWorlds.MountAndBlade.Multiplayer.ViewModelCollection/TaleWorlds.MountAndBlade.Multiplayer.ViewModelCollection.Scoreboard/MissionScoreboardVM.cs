...
public class MissionScoreboardVM : ViewModel
{
	...
	public MissionScoreboardVM(bool isSingleTeam, Mission mission)
	{
		...
		_muteAllText = new TextObject("{=AZSbwcG5}Mute All", (Dictionary<string, object>)null);
		_unmuteAllText = new TextObject("{=SzRVIPeZ}Unmute All", (Dictionary<string, object>)null);
	...
	private void UpdateSideAllPlayersAttributes(BattleSideEnum battleSide)
	{
		...
		MissionScoreboardSide val = _missionScoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0004: Unknown result type (might be due to invalid IL or missing references)
			//IL_000a: Unknown result type (might be due to invalid IL or missing references)
			return s != null && s.Side == battleSide;
		});
		if (val == null)
		{
			return;
	...
	private bool IsSideValid(BattleSideEnum side)
	{
		...
		{
			return _missionScoreboardComponent.Sides.Any(delegate(MissionScoreboardSide s)
			{
				//IL_0004: Unknown result type (might be due to invalid IL or missing references)
				//IL_000a: Unknown result type (might be due to invalid IL or missing references)
				return s != null && s.Side == side;
			});
		}
		return false;
	}
	...
	private void InitSides()
	{
		...
		MissionScoreboardSide val3 = _missionScoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0004: Unknown result type (might be due to invalid IL or missing references)
			//IL_000a: Invalid comparison between Unknown and I4
			return s != null && (int)s.Side == 1;
		});
		MissionScoreboardSide val4 = _missionScoreboardComponent.Sides.FirstOrDefault(delegate(MissionScoreboardSide s)
		{
			//IL_0004: Unknown result type (might be due to invalid IL or missing references)
			//IL_000a: Invalid comparison between Unknown and I4
			return s != null && (int)s.Side == 0;
		});

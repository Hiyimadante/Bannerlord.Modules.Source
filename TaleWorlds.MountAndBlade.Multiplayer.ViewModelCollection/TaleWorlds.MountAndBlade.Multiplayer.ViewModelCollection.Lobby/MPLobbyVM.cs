...
public class MPLobbyVM : ViewModel
{
	public enum LobbyPage
	{
		...
		Matchmaking = 6,
		Profile = 7,
		HotkeySelectablePageBegin = Options,
		HotkeySelectablePageEnd = Profile
	}
	...
	public void OnNotificationsReceived(LobbyNotification[] notifications)
	{
		...
		List<LobbyNotification> notifications2 = notifications.Where(delegate(LobbyNotification n)
		{

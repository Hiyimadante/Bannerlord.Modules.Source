...
public class MPAfterBattlePopupVM : ViewModel
{
	...
	public MPAfterBattlePopupVM(Func<string> getExitText)
	{
		...
		_pointsGainedTextObj = new TextObject("{=EFU3uo0y}You've gained {POINTS} points", (Dictionary<string, object>)null);
		_pointsLostTextObj = new TextObject("{=oMYz0PvL}You've lost {POINTS} points", (Dictionary<string, object>)null);

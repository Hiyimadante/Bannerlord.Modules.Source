...
public class PsaiProject : ICloneable
{
	...
	public object Clone()
	{
		...
		foreach (Theme key2 in dictionary.Keys)
		{
			...
			{
				if (Enumerable.Contains(dictionary.Keys, manuallyBlockedTargetTheme))
				{
		...
		foreach (Group key3 in dictionary3.Keys)
		{
			...
			{
				if (Enumerable.Contains(dictionary3.Keys, manuallyLinkedGroup))
				{
			...
			{
				if (Enumerable.Contains(dictionary3.Keys, manuallyBlockedGroup))
				{
			...
			{
				if (Enumerable.Contains(dictionary2.Keys, manualBridgeSnippetsOfTargetGroup))
				{
		...
		foreach (Segment item2 in segmentsOfAllThemes)
		{
			...
			{
				if (Enumerable.Contains(dictionary2.Keys, manuallyBlockedSnippet))
				{
			...
			{
				if (Enumerable.Contains(dictionary2.Keys, manuallyLinkedSnippet))
				{

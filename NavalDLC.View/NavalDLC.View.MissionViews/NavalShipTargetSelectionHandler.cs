...
public class NavalShipTargetSelectionHandler : MissionView
{
	...
	public override void OnPreDisplayMissionTick(float dt)
	{
		...
		OnShipsFocused?.Invoke((MBReadOnlyList<MissionShip>)(object)_focusedShipsCache);
	}
	...
	public NavalShipTargetSelectionHandler()
	{
		...
		_distanceCache = new List<(MissionShip, float)>();
		_focusedShipsCache = new MBList<MissionShip>();
		_enemyShipsCache = new MBList<MissionShip>();

...
public class NavalFinalConversationMissionView : MissionView
{
	...
	public override void OnMissionTick(float dt)
	{
		...
		{
			Agent val = ((IEnumerable<Agent>)Mission.Current.Agents).FirstOrDefault((Agent x) => (object)x.Character == StoryModeHeroes.LittleSister.CharacterObject);
	...
	private void TransitionToSister()
	{
		...
		Agent? obj = ((IEnumerable<Agent>)Mission.Current.Agents).FirstOrDefault((Agent x) => (object)x.Character == NavalStorylineData.Gunnar.CharacterObject);

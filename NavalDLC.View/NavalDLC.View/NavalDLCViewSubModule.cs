...
public class NavalDLCViewSubModule : MBSubModuleBase
{
	...
	protected override void OnSubModuleLoad()
	{
		...
		VisualOrderFactory.RegisterProvider((VisualOrderProvider)(object)_raidVisualOrderProvider);
	...
	protected override void OnSubModuleUnloaded()
	{
		...
		VisualOrderFactory.UnregisterProvider((VisualOrderProvider)(object)_raidVisualOrderProvider);
	...
	{
		InformationManager.RegisterTooltip<Ship, PropertyBasedTooltipVM>((Action<PropertyBasedTooltipVM, object[]>)NavalTooltipRefresherCollection.RefreshShipTooltip, "PropertyBasedTooltip");

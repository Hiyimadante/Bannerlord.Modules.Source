...
public class NavalMenuViewContext : MenuViewContext
{
	...
	{
		return ((MenuViewContext)this).AddMenuView<NavalMenuTroopSelectionView>(new object[10] { fullRoster, initialTroopSelections, eligibleShips, initialShipSelections, canChangeStatusOfTroop, onDone, minSelectableTroopCount, minSelectableShipCount, maxSelectableShipCount, anyOtherPartiesOnPlayerSide });
	}
}

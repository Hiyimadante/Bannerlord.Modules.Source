...
public class NavalOrderTroopPlacer : OrderTroopPlacer
{
	...
	protected override bool CanUpdate()
	{
		...
		bool num = ((OrderTroopPlacer)this).OrderController == Mission.Current.PlayerEnemyTeam.MasterOrderController;
		bool flag = ((MissionBehavior)this).Mission.IsNavalRaidBattle && (int)((OrderTroopPlacer)this).OrderController.Team.Side == 0;
		if (num | flag)
		{

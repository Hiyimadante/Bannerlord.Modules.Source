...
{
	[CompilerGenerated]
	private readonly OrderType _003CPositiveOrder_003Ek__BackingField;

	[CompilerGenerated]
	private readonly OrderType _003CNegativeOrder_003Ek__BackingField;
	...
	public OrderType PositiveOrder
	{
		...
		get
		{
			...
			return _003CPositiveOrder_003Ek__BackingField;
		}
	}
	...
	public OrderType NegativeOrder
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CNegativeOrder_003Ek__BackingField;
		}
	}
	...
	public GenericToggleVisualOrder(string stringId, OrderType positiveOrder, OrderType negativeOrder)
	{
		...
		((VisualOrder)this)._002Ector(stringId);

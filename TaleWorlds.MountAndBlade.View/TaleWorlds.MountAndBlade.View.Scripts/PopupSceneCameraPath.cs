...
public class PopupSceneCameraPath : ScriptComponentBehavior
{
	...
	public PopupSceneCameraPath()
	{
		...
		LookAtEntity = "";
		SkeletonName = "";
		AttachmentOffset = new Vec3(0f, 0f, 0f, -1f);
		InitialPath = "";
		InitialAnimationClip = "";
		InitialSound = "event:/mission/siege/siegetower/doorland";
		InitialPathDuration = 1f;
		PositivePath = "";
		PositiveAnimationClip = "";
		PositiveSound = "";
		PositivePathDuration = 1f;
		NegativePath = "";
		NegativeAnimationClip = "";
		NegativeSound = "";
		NegativePathDuration = 1f;
		_localFrameIdentity = MatrixFrame.Identity;
		_skeletonAnims = new List<PopupSceneSkeletonAnimationScript>();
		_transitionState = new PathAnimationState[3];

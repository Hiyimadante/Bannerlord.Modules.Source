...
public class MapColorGradeManager : ScriptComponentBehavior
{
	...
	public MapColorGradeManager()
	{
		...
		colorGradeGridName = "worldmap_colorgrade_grid";
		colorGradeGrid = new byte[262144];
		colorGradeGridMapping = new Dictionary<byte, string>();
		terrainSize = new Vec2(1f, 1f);
		defaultColorGradeTextureName = "worldmap_colorgrade_stratosphere";

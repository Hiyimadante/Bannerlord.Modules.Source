...
public class HandMorphTest : ScriptComponentBehavior
{
	...
	public HandMorphTest()
	{
		...
		act_defend_up_fist_active = ActionIndexCache.Create("act_defend_up_fist_active");
		act_visual_test_morph_animation = ActionIndexCache.Create("act_visual_test_morph_animation");

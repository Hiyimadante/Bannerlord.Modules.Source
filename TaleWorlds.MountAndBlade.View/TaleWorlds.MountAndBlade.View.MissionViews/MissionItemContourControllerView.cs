...
public class MissionItemContourControllerView : MissionView
{
	...
	private void PopulateContourListWithNearbyItems()
	{
		...
		for (int k = 0; k < num7; k++)
		{
			...
			if (((WeakGameEntity)(ref validStandingPointForAgentWithoutDistanceCheck)).IsValid && !(((WeakGameEntity)(ref validStandingPointForAgentWithoutDistanceCheck)).GetFirstScriptOfType<UsableMissionObject>() is SpawnedItemEntity))
			{
				ScriptComponentBehavior? obj = ((WeakGameEntity)(ref validStandingPointForAgentWithoutDistanceCheck)).GetScriptComponents().FirstOrDefault((ScriptComponentBehavior sc) => sc is IFocusable);
				IFocusable val18;
				if ((val18 = (IFocusable)(object)((obj is IFocusable) ? obj : null)) != null && val18 is UsableMissionObject)
				{
	...
	public MissionItemContourControllerView()
	{
		...
		_tempPickableEntities = (WeakGameEntity[])(object)new WeakGameEntity[128];
		_pickableItemsId = new UIntPtr[128];

...
public class OrderFlag
{
	...
	public void Tick(float dt)
	{
		...
		if (flag)
		{
			...
			if (((WeakGameEntity)(ref val)).IsValid)
			{
				...
				IOrderable val2 = (IOrderable)((WeakGameEntity)(ref val)).GetScriptComponents().First(delegate(ScriptComponentBehavior sc)
				{
					//IL_000c: Unknown result type (might be due to invalid IL or missing references)
					//IL_0011: Unknown result type (might be due to invalid IL or missing references)
					//IL_0017: Invalid comparison between Unknown and I4
					IOrderable val4;
					return (val4 = (IOrderable)(object)((sc is IOrderable) ? sc : null)) != null && (int)val4.GetOrder(side) > 0;
				});
		...
		{
			FocusedOrderableObject = (IOrderable)(object)_orderablesWithInteractionArea.FirstOrDefault(delegate(IOrderableWithInteractionArea o)
			{
	...
	private WeakGameEntity GetCollidedEntity(out Vec3 closestPoint)
	{
		...
		while (((WeakGameEntity)(ref parent)).IsValid && !((WeakGameEntity)(ref parent)).GetScriptComponents().Any(delegate(ScriptComponentBehavior sc)
		{
			//IL_0015: Unknown result type (might be due to invalid IL or missing references)
			//IL_001a: Unknown result type (might be due to invalid IL or missing references)
			//IL_0020: Invalid comparison between Unknown and I4
			IOrderable val3;
			return (val3 = (IOrderable)(object)((sc is IOrderable) ? sc : null)) != null && (int)val3.GetOrder(Mission.Current.PlayerTeam.Side) > 0;
		}))
		{

...
{
	[CompilerGenerated]
	private readonly ArrangementOrderEnum _003CArrangementOrder_003Ek__BackingField;
	...
	public ArrangementOrderEnum ArrangementOrder
	{
		...
		get
		{
			...
			return _003CArrangementOrder_003Ek__BackingField;
		}
	}
	...
	public ArrangementVisualOrder(ArrangementOrderEnum arrangementOrder, string iconId)
	{
		...
		((VisualOrder)this)._002Ector(iconId);
	...
	public override TextObject GetName(OrderController orderController)
	{
		...
		return (TextObject)((int)arrangementOrder switch
		{
			...
			7 => (object)new TextObject("{=squareOrder}Square", (Dictionary<string, object>)null), 

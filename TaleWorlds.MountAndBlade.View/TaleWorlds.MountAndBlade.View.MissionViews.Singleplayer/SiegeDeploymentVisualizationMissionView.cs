...
public class SiegeDeploymentVisualizationMissionView : MissionView
{
	...
	{
		SynchedMissionObject? obj = ((IEnumerable<SynchedMissionObject>)deploymentPoint.GetWeaponsUnder()).FirstOrDefault((SynchedMissionObject wu) => wu is IMoveableSiegeWeapon);

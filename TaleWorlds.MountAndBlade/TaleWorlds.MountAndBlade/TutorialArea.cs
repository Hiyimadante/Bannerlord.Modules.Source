...
public class TutorialArea : MissionObject
{
	...
	private struct TutorialEntity(string tag, List<Tuple<GameEntity, MatrixFrame>> entityList, List<DestructableComponent> destructableComponents, List<GameEntity> weapon, List<ItemObject> weaponNames)
	{
		public string Tag = tag;

		public List<Tuple<GameEntity, MatrixFrame>> EntityList = entityList;

		public List<DestructableComponent> DestructableComponents = destructableComponents;

		public List<GameEntity> WeaponList = weapon;

		public List<ItemObject> WeaponNames = weaponNames;
	}

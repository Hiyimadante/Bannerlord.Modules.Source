...
{
	private struct RelativeFormationPosition(bool fromLeftFile, int fileOffset, bool fromFrontRank, int rankOffset, float fileFractionalOffset = 0f, float rankFractionalOffset = 0f)
	{
		public readonly bool FromLeftFile = fromLeftFile;

		public readonly int FileOffset = fileOffset;

		public readonly float FileFractionalOffset = MathF.Clamp(fileFractionalOffset, 0f, 1f);

		public readonly bool FromFrontRank = fromFrontRank;

		public readonly int RankOffset = rankOffset;

		public readonly float RankFractionalOffset = MathF.Clamp(rankFractionalOffset, 0f, 1f);

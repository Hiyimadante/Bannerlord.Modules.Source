...
public sealed class Formation : IFormation
{
	...
	{
		public Vec2 AverageVelocityExcludeFarAgents = averageVelocityExcludeFarAgents;

		public float DeviationOfPositionsExcludeFarAgents = deviationOfPositionsExcludeFarAgents;

		public float MaxDeviationOfPositionExcludeFarAgents = maxDeviationOfPositionExcludeFarAgents;

		public float AverageMaxUnlimitedSpeedExcludeFarAgents = averageMaxUnlimitedSpeedExcludeFarAgents;
	}
	...
	{
		OnBeforeMovementOrderApplied?.Invoke(this, input.OrderEnum);
	...
	public void SetArrangementOrder(ArrangementOrder order)
	{
		if (order.OrderType != ArrangementOrder.OrderType)
		{
			...
			OnAfterArrangementOrderApplied?.Invoke(this, ArrangementOrder.OrderEnum);
	...
	public void SetPositioning(WorldPosition? position = null, Vec2? direction = null, int? unitSpacing = null)
	{
		...
		if (newPosition.HasValue | flag | flag2)
		{
			...
			if (flag2)
			{
				...
				OnUnitSpacingChanged?.Invoke(this);
				Arrangement_OnShapeChanged();
	...
	public void OnUnitAddedOrRemoved()
	{
		...
		OnUnitCountChanged?.Invoke(this);
	}
	...
	public void AttachUnit(Agent unit)
	{
		...
		_movementOrder.OnUnitJoinOrLeave(this, unit, isJoining: true);
		OnUnitAttachedOrDetached();
		OnUnitAttached?.Invoke(this, unit);
	}

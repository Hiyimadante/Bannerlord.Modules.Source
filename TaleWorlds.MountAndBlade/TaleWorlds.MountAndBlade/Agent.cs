...
public sealed class Agent : DotNetObject, IAgent, IFocusable, IUsable, IFormationUnit, ITrackableBase
{
	...
	public enum ActionCodeType
	{
		...
		StrikeEnd = MountStrike,
		DefendAllBegin = DefendFist,
		DefendAllEnd = ReadyRanged,
		AttackMeleeAllBegin = ReadyMelee,
		AttackMeleeAllEnd = Fall,
		AttackMeleeAndRangedAllBegin = ReadyRanged,
		AttackMeleeAndRangedAllEnd = Fall,
		CombatAllBegin = DefendFist,
		CombatAllEnd = Fall,
		...
		FallAllEnd = Kick,
		KickAllBegin = Kick,
		KickAllEnd = WeaponBash,
		AlternativeAttackAllBegin = Kick,
		AlternativeAttackAllEnd = PassiveUsage
	}
	...
	public enum MovementControlFlag : uint
	{
		...
		MaxValue = MoveMask | DefendMask | AttackMask | DefendBlock | Action
	}
	...
	public enum UsageDirection
	{
		...
		AttackLeft = 2,
		AttackRight = 3,
		AttackBegin = AttackUp,
		AttackEnd = 4,
		DefendUp = AttackEnd,
		DefendDown = 5,
		DefendLeft = 6,
		DefendRight = 7,
		DefendBegin = AttackEnd,
		DefendAny = 8,
		DefendEnd = 9,
		AttackAny = DefendEnd
	}
	...
	public MissionPeer MissionPeer
	{
		...
		set
		{
			...
			if (_missionPeer != null && _missionPeer.ControlledAgent != this)
			{
				...
				{
					SyncHealthToClients();
					OnAgentHealthChanged?.Invoke(this, Health, Health);
				}
			}
			if (value != null)
			{
	...
	public float Health
	{
		...
		set
		{
			...
			if (!_health.ApproximatelyEqualsTo(num))
			{
				...
				OnAgentHealthChanged?.Invoke(this, health, _health);
				if (RiderAgent != null)
				{

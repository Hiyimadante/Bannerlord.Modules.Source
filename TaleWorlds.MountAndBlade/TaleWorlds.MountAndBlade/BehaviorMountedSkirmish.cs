...
{
	private struct Ellipse(Vec2 center, float radius, float halfLength, Vec2 direction)
	{
		private readonly Vec2 _center = center;

		private readonly float _radius = radius;

		private readonly float _halfLength = halfLength;

		private readonly Vec2 _direction = direction;

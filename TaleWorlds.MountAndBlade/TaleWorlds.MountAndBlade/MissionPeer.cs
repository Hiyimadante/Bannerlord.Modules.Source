...
public class MissionPeer : PeerComponent
{
	...
	public int SelectedTroopIndex
	{
		...
		set
		{
			if (_selectedTroopIndex != value)
			{
				...
				ResetSelectedPerks();
				OnEquipmentIndexRefreshed?.Invoke(this, value);
			}
		}
	}
	...
	public Team Team
	{
		...
		set
		{
			...
			if (OnPreTeamChanged != null)
			{
				OnPreTeamChanged(this.GetNetworkPeer(), _team, value);
			}
			Team team = _team;
			_team = value;
			...
			if (_team != null)
			{
				...
				{
					OnTeamChanged(this.GetNetworkPeer(), team, _team);
				}
			}
	...
	public bool SelectPerk(int perkListIndex, int perkIndex, int enforcedSelectedTroopIndex = -1)
	{
		...
		if (perkIndex != _perks[num][perkListIndex])
		{
			...
			OnPerkSelectionUpdated?.Invoke(this);
			return true;
		}
		return false;
	}
	...
	public void OnKillAnotherPeer(MissionPeer victimPeer)
	{
		if (victimPeer != null)
		{
			...
			OnPlayerKilled?.Invoke(this, victimPeer);
		}
	}

...
public class ColumnFormation : IFormationArrangement
{
	...
	public bool AddUnit(IFormationUnit unit)
	{
		...
		if (flag)
		{
			IFormationUnit unitToFollow = GetUnitToFollow(unit, out var columnOffset);
	...
	public void TurnBackwards()
	{
		...
		{
			IFormationUnit unitToFollow = GetUnitToFollow(allUnit, out var columnOffset);

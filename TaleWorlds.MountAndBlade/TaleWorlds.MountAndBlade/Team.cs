...
public class Team : IMissionTeam
{
	...
	{
		OnOrderIssued?.Invoke(orderType, appliedFormations, orderController, delegateParams);
	}
	...
	private void FormationAI_OnActiveBehaviorChanged(Formation formation)
	{
		...
		{
			OnFormationAIActiveBehaviorChanged?.Invoke(formation);
		}
	}
	...
	{
		OnFormationsChanged?.Invoke(this, formation);
	}

	public void TriggerOnFormationsChangedInDeployment()
	{
		OnFormationsChangedInDeployment?.Invoke(this);
	}

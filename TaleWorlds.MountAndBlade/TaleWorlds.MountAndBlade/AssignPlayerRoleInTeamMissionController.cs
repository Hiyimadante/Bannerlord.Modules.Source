...
public class AssignPlayerRoleInTeamMissionController : MissionLogic
{
	...
	public virtual void OnPlayerTeamDeployed()
	{
		...
		OnPlayerTurnToChooseFormationToLead?.Invoke(FormationsLockedWithSergeants, RemainingFormationsToAssignSergeantsTo.Select((Formation ftcsf) => ftcsf.Index).ToList());
	}
	...
	public virtual void OnPlayerChoiceMade(int chosenIndex)
	{
		...
		if (OnAllFormationsAssignedSergeants != null)
		{
			OnAllFormationsAssignedSergeants(FormationsWithLooselyChosenSergeants);
		}
	}

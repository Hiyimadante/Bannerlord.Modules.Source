...
public class FormationAI
{
	...
	public enum BehaviorSide
	{
		...
		ValidBehaviorSideCount = BehaviorSideNotSet
	}
	...
	public BehaviorComponent ActiveBehavior
	{
		...
		private set
		{
			if (_activeBehavior != value)
			{
				...
				if (OnActiveBehaviorChanged != null && (activeBehavior == null || !activeBehavior.Equals(value)))
				{
					OnActiveBehaviorChanged(_formation);
				}
			}
		}
	}

...
public class DebugObjectDestroyerMissionController : MissionLogic
{
	...
	public override void OnMissionTick(float dt)
	{
		...
		bool flag = Mission.Current.Scene.RayCastForClosestEntityOrTerrain(lastFinalRenderCameraPosition, lastFinalRenderCameraPosition + vec * 100f, out float collisionDistance, out WeakGameEntity collidedEntity, 0.01f, BodyFlags.OnlyCollideWithRaycast);

...
{
	private struct MeshNormalizationInfo(float meshWidth, float meshHeight, float[] normalizedVertices)
	{
		public readonly float MeshWidth = meshWidth;

		public readonly float MeshHeight = meshHeight;

		public readonly float[] NormalizedVertices = normalizedVertices;
	}

...
public class NavalOrderOfBattleFormationItemVM : ViewModel
{
	...
	[CompilerGenerated]
	private DeploymentFormationClass _003CSelectedClass_003Ek__BackingField;
	...
	public DeploymentFormationClass SelectedClass
	{
		...
		get
		{
			...
			return _003CSelectedClass_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CSelectedClass_003Ek__BackingField = value;
		}
	}
	...
	public NavalOrderOfBattleFormationItemVM(Formation formation, Action<NavalOrderOfBattleFormationItemVM> onSelected, Action<NavalOrderOfBattleFormationItemVM> onClassChanged, Action<NavalOrderOfBattleFormationItemVM> onFilterToggled)
	{
		...
		_captainSlotHintText = new TextObject("{=shipcaptain}Captain", (Dictionary<string, object>)null);
		_shipSlotHintText = new TextObject("{=1nbU1tV5}Ship", (Dictionary<string, object>)null);
		_assignCaptainHintText = new TextObject("{=rHEi6aVz}Assign as Captain", (Dictionary<string, object>)null);
		_assignShipHintText = new TextObject("{=6o2JKNbt}Assign as Ship", (Dictionary<string, object>)null);
		_infantryHintText = new TextObject("{=IxI1HecC}Give preference to infantry troops", (Dictionary<string, object>)null);
		_rangedHintText = new TextObject("{=I9X4VvhG}Give preference to ranged troops", (Dictionary<string, object>)null);
		_infantryAndRangedHintText = new TextObject("{=e9nO59x4}Give equal preference to infantry and ranged troops", (Dictionary<string, object>)null);
		_filteredTroopCountInfoText = new TextObject("{=yRIPADWl}{TROOP_COUNT}/{TOTAL_TROOP_COUNT}", (Dictionary<string, object>)null);
	...
	public bool HasFilter(FormationFilterType filter)
	{
		...
		return ((IEnumerable<OrderOfBattleFormationFilterSelectorItemVM>)FilterItems).Any(delegate(OrderOfBattleFormationFilterSelectorItemVM f)
		{
			//IL_0009: Unknown result type (might be due to invalid IL or missing references)
			//IL_000f: Unknown result type (might be due to invalid IL or missing references)
			return f.IsActive && f.FilterType == filter;
		});
	}

...
public struct Vector4 : IEquatable<Vector4>, IFormattable
{
	...
	public void CopyTo(float[] array, int index)
	{
		...
		{
			throw new ArgumentOutOfRangeException("index", System.SR.Format(System.SR.Arg_ArgumentOutOfRangeException, index));
		}
		if (array.Length - index < 4)
		{
			throw new ArgumentException(System.SR.Format(System.SR.Arg_ElementsInSourceIsGreaterThanDestination, index));
		}
		array[index] = X;
		array[index + 1] = Y;
		array[index + 2] = Z;

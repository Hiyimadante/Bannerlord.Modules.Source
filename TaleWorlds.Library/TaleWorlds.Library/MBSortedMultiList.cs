...
public class MBSortedMultiList<TKey, TValue> : IReadOnlyList<TValue>, IEnumerable<TValue>, IEnumerable, IReadOnlyCollection<TValue>, IMBCollection where TKey : IComparable<TKey>
{
	...
	private struct SMLValueEnumerator(List<KeyValuePair<TKey, TValue>> list) : IEnumerator<TValue>, IEnumerator, IDisposable
	{
		private readonly List<KeyValuePair<TKey, TValue>> _list = list;
	...
	private struct SMLKeyValueEnumerator(List<KeyValuePair<TKey, TValue>> list, TKey key, int startIndex) : IEnumerator<TValue>, IEnumerator, IDisposable
	{
		private readonly List<KeyValuePair<TKey, TValue>> _list = list;

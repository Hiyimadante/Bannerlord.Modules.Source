...
public static class InformationManager
{
	...
	{
		public Type TooltipType = tooltipType;

		public object OnRefreshData = onRefreshData;
	...
	{
		DisplayMessageInternal?.Invoke(message);
	}

	public static void HideAllMessages()
	{
		HideAllMessagesInternal?.Invoke();
	}

	public static void ClearAllMessages()
	{
		ClearAllMessagesInternal?.Invoke();
	}

	public static void AddSystemNotification(string message)
	{
		OnAddSystemNotification?.Invoke(message);
	}

	public static void ShowTooltip(Type type, params object[] args)
	{
		OnShowTooltip?.Invoke(type, args);
	}
	...
	{
		DisplayMessageInternal = null;
		HideAllMessagesInternal = null;
		ClearAllMessagesInternal = null;
		OnShowInquiry = null;
		OnShowTextInquiry = null;
		OnHideInquiry = null;

...
public class GauntletMenuTownManagementView : MenuView
{
	...
	protected override void OnFrameTick(float dt)
	{
		...
		else if (base.Layer.Input.IsHotKeyReleased("Exit"))
		{
			...
			{
				SettlementBuildingProjectVM val = ((IEnumerable<SettlementBuildingProjectVM>)_dataSource.ProjectSelection.AvailableProjects).FirstOrDefault((SettlementBuildingProjectVM x) => x.IsSelected);
				if (val != null)
				{

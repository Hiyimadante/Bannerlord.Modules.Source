...
public class GauntletTutorialSystem : GlobalLayer
{
	...
	[CompilerGenerated]
	private EncyclopediaPages _003CCurrentEncyclopediaPageContext_003Ek__BackingField;

	[CompilerGenerated]
	private TutorialContexts _003CCurrentContext_003Ek__BackingField;
	...
	public EncyclopediaPages CurrentEncyclopediaPageContext
	{
		...
		get
		{
			...
			return _003CCurrentEncyclopediaPageContext_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003CCurrentEncyclopediaPageContext_003Ek__BackingField = value;
		}
	}
	...
	public TutorialContexts CurrentContext
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CCurrentContext_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CCurrentContext_003Ek__BackingField = value;
		}
	}
